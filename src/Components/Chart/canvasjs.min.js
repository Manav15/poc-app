...
(function () {
  ...
  var fb = function () { var g = !1; try { var l = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { g = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, l), window.removeEventListener("test", null, l)) } catch (v) { g = !1 } return g }(), Xa = {}, wa = null, kb = function () { this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) }, lb = function (g, l, v) {
    ...
    E = /[^-+\dA-Z]/g; return function (F, N, M) {
      var H = M ? M.days : l, P = M ? M.months : s, J = M ? M.shortDays : v, R = M ? M.shortMonths : w; M = ""; var S = !1; F = F && F.getTime ? F : F ? new Date(F) : new Date; if (isNaN(F)) throw SyntaxError("invalid date"); "UTC:" === N.slice(0, 4) && (N = N.slice(4), S = !0); M = S ? "getUTC" : "get"; var U = F[M + "Date"](), K = F[M + "Day"](), V = F[M + "Month"](), a = F[M + "FullYear"](), d = F[M + "Hours"](), b = F[M + "Minutes"](), c = F[M + "Seconds"](), e = F[M + "Milliseconds"](), f = S ? 0 : F.getTimezoneOffset(); return M = N.replace(g, function (p) {
        switch (p) {
          case "D": return U;
  ...
  U.prototype.setOptions = function (g, l) { if (pa[this._defaultsKey]) { var s = pa[this._defaultsKey], w; for (w in s) "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = g && w in g ? g[w] : l && w in l ? l[w] : s[w]) } else Ga && window.console && console.log("defaults not set") }; U.prototype.get = function (g) {
    ...
    function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Da.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; oa(ia, U); ia.prototype._initialize = function () {
      ...
      "undefined" !== typeof module.exports ? module.exports = Oa : "function" === typeof define && define.amd ? define([], function () { return Oa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Oa); y = Oa.Chart = function () {
        function g(a, d) { return a.x - d.x } function l(a, d, b) {
          d = d || {}; s(b) ? (this.predefinedThemes = ab, this.optionsName =
          ...
          for (var b = [], c, e = 0; e < a.length; e++)if (0 == e) b.push(a[0]); else {
            var f, p, t; t = e - 1; f = 0 === t ? 0 : t - 1; p = t === a.length - 1 ? t : t + 1; c = Math.abs((a[p].x - a[f].x) / (0 === a[p].x - a[t].x ? 0.01 : a[p].x - a[t].x)) * (d - 1) /
              2 + 1; var B = (a[p].x - a[f].x) / c; c = (a[p].y - a[f].y) / c; b[b.length] = a[t].x > a[f].x && 0 < B || a[t].x < a[f].x && 0 > B ? { x: a[t].x + B / 3, y: a[t].y + c / 3 } : { x: a[t].x, y: a[t].y + c / 9 }; t = e; f = 0 === t ? 0 : t - 1; p = t === a.length - 1 ? t : t + 1; c = Math.abs((a[p].x - a[f].x) / (0 === a[t].x - a[f].x ? 0.01 : a[t].x - a[f].x)) * (d - 1) / 2 + 1; B = (a[p].x - a[f].x) / c; c = (a[p].y - a[f].y) / c; b[b.length] = a[t].x > a[f].x && 0 < B || a[t].x < a[f].x && 0 > B ? { x: a[t].x - B / 3, y: a[t].y - c / 3 } : { x: a[t].x, y: a[t].y - c / 9 }; b[b.length] = a[e]
          } return b
          ...
          H.base.constructor.call(this, "DataSeries", "data", d, b,
          ...
          E.base.constructor.call(this, "Axis", d, b, c, a); this.chart = a; this.canvas = a.canvas; this.ctx = a.ctx; this.intervalStartPosition = this.maxHeight = this.maxWidth = 0; this.labels = []; this.dataSeries = []; this._stripLineLabels = this._ticks = this._labels = null; this.dataInfo = {
            min: Infinity, max: -Infinity, viewPortMin: Infinity,
            viewPortMax: -Infinity, minDiff: Infinity
          }; this.isOptionsInArray = !0; "axisX" === e ? ("left" === f || "bottom" === f ? (this.optionsName = "axisX", s(this.chart.sessionVariables.axisX[c]) && (this.chart.sessionVariables.axisX[c] = {}), this.sessionVariables = this.chart.sessionVariables.axisX[c]) : (this.optionsName = "axisX2", s(this.chart.sessionVariables.axisX2[c]) && (this.chart.sessionVariables.axisX2[c] = {}), this.sessionVariables = this.chart.sessionVariables.axisX2[c]), this.options.interval || (this.intervalType = null)) : "left" ===
          ...
          T.base.constructor.call(this, "Break", d, b, c, f); this.id = e; this.chart = a; this.ctx = this.chart.ctx; this.scaleBreaks = f; this.optionsName =
        ...
        } function $(a, d, b) { $.base.constructor.call(this, "Crosshair", "crosshair", d, null, b); this.chart = a; this.ctx = this.chart.ctx; this.axis = b; this.optionsName = "crosshair"; this._thicknessType = "pixel" } function X(a, d) {
          ...
          var a =
            this; this.updateOption("width"); this.updateOption("height"); this.updateOption("dataPointWidth"); this.updateOption("dataPointMinWidth"); this.updateOption("dataPointMaxWidth"); this.updateOption("interactivityEnabled"); this.updateOption("theme"); this.updateOption("colorSet") && (this.selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo =
              new Ia(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && w; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); this.toolbar = new Sa(this, this.options.toolbar); if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this.options.toolTip); for (var b in this.toolTip.options) this.toolTip.options.hasOwnProperty(b) && this.toolTip.updateOption(b)
          ...
          var a; a = [this.canvas, this.overlaidCanvas, this._eventManager.ghostCanvas]; var d = 0, b = 0; this.options.width ? d = this.width : this.width = d = 0 < this.container.clientWidth ? this.container.clientWidth : this.width; this.options.height ? b = this.height : this.height = b = 0 < this.container.clientHeight ? this.container.clientHeight : this.height; if (this.canvas.width !== d *
            ka || this.canvas.height !== b * ka) { for (var c = 0; c < a.length; c++)La(a[c], d, b); this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height, width: this.width, height: this.height }; a = !0 } else a = !1; return a
          ...
          this.isNavigator = s(this.parent) || s(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0; this._animator ? this._animator.cancelAllAnimations() : this._animator = new ha(this); this.removeAllEventListeners(); this.disableToolTip = !1; this._axes = []; this.funnelPyramidClickHandler =
            this.pieDoughnutClickHandler = null; this._updateOptions(); this.animatedRender = w && this.animationEnabled && 0 === this.renderCount; this._updateSize(); this.clearCanvas(); this.ctx.beginPath(); this.axisX = []; this.axisX2 = []; this.axisY = []; this.axisY2 = []; this._indexLabels = []; this._dataInRenderedOrder = []; this._events = []; this._eventManager && this._eventManager.reset(); this.plotInfo = { axisPlacement: null, plotTypes: [] }; this.layoutManager = new Da(0, 0, this.width, this.height, this.isNavigator ? 0 : 2); this.plotArea.layoutManager &&
              this.plotArea.layoutManager.reset(); this.data = []; this.title = null; this.subtitles = []; var a = 0, d = null; if (this.options.data) {
                for (var b = 0; b < this.options.data.length; b++)if (a++, !this.options.data[b].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[b].type)) {
                  var c = new H(this, this.options.data[b], a - 1, ++this._eventManager.lastObjectId); "error" === c.type && (c.linkedDataSeriesIndex = s(this.options.data[b].linkedDataSeriesIndex) ? b - 1 : this.options.data[b].linkedDataSeriesIndex, 0 > c.linkedDataSeriesIndex || c.linkedDataSeriesIndex >=
                      ...
                      c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "candlestick" === c.type || "ohlc" === c.type || "waterfall" === c.type || "boxAndWhisker" === c.type ? [this.selectedColorSet[0]] : this.selectedColorSet : c._colorSet = [c.color]; null === c.markerSize && (("line" === c.type || "stepLine" === c.type || "spline" === c.type || 0 <= c.type.toLowerCase().indexOf("area")) && c.dataPoints && c.dataPoints.length < this.width / 16 || "scatter" === c.type) && (c.markerSize = 8); "bubble" !== c.type && "scatter" !==
                        c.type || !c.dataPoints || (c.dataPoints.some ? c.dataPoints.some(function (a) { return a.x }) && c.dataPoints.sort(g) : c.dataPoints.sort(g)); this.data.push(c); var e = c.axisPlacement, d = d || e, f; "normal" === e ? "xySwapped" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with bar chart' : "none" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with pie chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "normal") : "xySwapped" === e ? "normal" === this.plotInfo.axisPlacement ?
                          f = 'You cannot combine "' + c.type + '" with line, area, column or pie chart' : "none" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with pie chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement = "xySwapped") : "none" === e ? "normal" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with line, area, column or bar chart' : "xySwapped" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' + c.type + '" with bar chart' : null === this.plotInfo.axisPlacement && (this.plotInfo.axisPlacement =
                            "none") : null === e && "none" === this.plotInfo.axisPlacement && (f = 'You cannot combine "' + c.type + '" with pie chart'); if (f && window.console) { window.console.log(f); return }
                } for (b = 0; b < this.data.length; b++) {
                  if ("none" == d && "error" === this.data[b].type && window.console) { window.console.log('You cannot combine "' + c.type + '" with error chart'); return } "error" === this.data[b].type && (this.data[b].axisPlacement = this.plotInfo.axisPlacement = d || "normal", this.data[b]._linkedSeries = null === this.data[b].linkedDataSeriesIndex ? null :
          ...
          for (var a = this._plotAreaElements, d = 0; d < this.data.length; d++)if ("normal" ===
            this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
              if (!this.data[d].axisYType || "primary" === this.data[d].axisYType) if (this.options.axisY && 0 < this.options.axisY.length) {
                if (!this.axisY.length) for (var b = 0; b < this.options.axisY.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new E(this, "axisY", this.options.axisY[b], b, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[b] = new E(this, "axisY", this.options.axisY[b], b, "axisY",
                ...
                "axisY", this.options.axisY, 0, "axisY", "bottom"))), this.data[d].axisY = this.axisY[0], this.axisY[0].dataSeries.push(this.data[d]); if ("secondary" === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                  if (!this.axisY2.length) for (b = 0; b < this.options.axisY2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new E(this, "axisY2", this.options.axisY2[b], b, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new E(this,
                    "axisY2", this.options.axisY2[b], b, "axisY", "top")); this.data[d].axisY = this.axisY2[0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY2.length ? this.data[d].axisYIndex : 0]; this.axisY2[0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY2.length ? this.data[d].axisYIndex : 0].dataSeries.push(this.data[d])
                  ...
                  this._axes.push(this.axisY2[0] = new E(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))), this.data[d].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[d]); if (!this.data[d].axisXType || "primary" === this.data[d].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
                    if (!this.axisX.length) for (b = 0; b < this.options.axisX.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new E(this, "axisX", this.options.axisX[b], b, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement &&
                      this._axes.push(this.axisX[b] = new E(this, "axisX", this.options.axisX[b], b, "axisX", "left")); this.data[d].axisX = this.axisX[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0]; this.axisX[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0].dataSeries.push(this.data[d])
                    ...
                    "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new E(this, "axisX", this.options.axisX, 0, "axisX", "left"))), this.data[d].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[d]); if ("secondary" === this.data[d].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                      if (!this.axisX2.length) for (b = 0; b < this.options.axisX2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new E(this, "axisX2", this.options.axisX2[b], b, "axisX", "top")) : "xySwapped" ===
            ...
            for (b =
              1; b < this.axisY2.length; b++)"undefined" === typeof this.axisY2[b].options.gridThickness && (this.axisY2[b].gridThickness = 0); for (b = 0; b < this.axisY2.length - 1; b++)"undefined" === typeof this.axisY2[b].options.margin && (this.axisY2[b].margin = 10)
          ...
          var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea || this.legend.render(); if ("normal" === this.plotInfo.axisPlacement || "xySwapped" ===
            this.plotInfo.axisPlacement) E.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var b = []; if (this.animatedRender) { var c = ta(this.width, this.height); c.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } hb(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit = 3; w && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas,
              0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
              ...
              } this.ctx.miterLimit = a; this.animatedRender && this._breaksCanvasCtx && b.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 }); this.animatedRender && 0 < this._indexLabels.length && (e = ta(this.width, this.height).getContext("2d"), b.push(this.renderIndexLabels(e))); var m = this; if (0 < b.length) m.disableToolTip = !0, m._animator.animate(200,
                m.animationDuration, function (a) { m.ctx.clearRect(0, 0, m.width, m.height); m.ctx.drawImage(c, 0, 0, Math.floor(m.width * ka), Math.floor(m.height * ka), 0, 0, m.width, m.height); for (var e = 0; e < b.length; e++)B = b[e], 1 > a && "undefined" !== typeof B.startTimePercent ? a >= B.startTimePercent && B.animationCallback(B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent), B) : B.animationCallback(B.easingFunction(a, 0, 1, 1), B); m.dispatchEvent("dataAnimationIterationEnd", { chart: m }) }, function () {
                  b = []; for (var a = 0; a < m.plotInfo.plotTypes.length; a++)for (var e =
                    m.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++)e.plotUnits[d].targetCanvas = null; c = null; m.disableToolTip = !1; m.dispatchEvent("dataAnimationEnd", { chart: m })
          ...
          for (var a = 0; a < this.data.length; a++) {
            var d =
              this.data[a]; if (d.dataPoints) for (var b = d.dataPoints.length, c = 0; c < b; c++)d.dataPointIds[c] = ++this._eventManager.lastObjectId
          }
          ...
          this.assignIdToDataPoints(); this.categoriseDataSeries(); for (var a = 0; a < this.plotInfo.plotTypes.length; a++)for (var d = this.plotInfo.plotTypes[a], b = 0; b < d.plotUnits.length; b++) {
            var c = d.plotUnits[b]; "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "bar" === c.type ||
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            var t = this.data[a.dataSeriesIndexes[p]], B = 0, k = !1, m = !1, n; if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
              this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, h = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (t.dataPoints[B].x && t.dataPoints[B].x.getTime || "dateTime" ===
                t.xValueType) f = !0; for (B = 0; B < t.dataPoints.length; B++) {
                  "undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)); t.dataPoints[B].x.getTime ? (f = !0, c = t.dataPoints[B].x.getTime()) : c = t.dataPoints[B].x; e = t.dataPoints[B].y; c < b.min && (b.min = c); c > b.max && (b.max = c); e < d.min && "number" === typeof e && (d.min = e); e > d.max && "number" === typeof e && (d.max = e); if (0 < B) {
                    if (a.axisX.logarithmic) { var r = c / t.dataPoints[B - 1].x; 1 > r && (r = 1 / r); b.minDiff > r && 1 !== r && (b.minDiff = r) } else r = c - t.dataPoints[B - 1].x, 0 > r &&
                      (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r); null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (r = e / t.dataPoints[B - 1].y, 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - t.dataPoints[B - 1].y, 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)))
                  } if (c < q && !k) null !== e && (n = c); else {
                    if (!k && (k = !0, 0 < B)) { B -= 2; continue } if (c > h && !m) m = !0; else if (c > h && m) continue; t.dataPoints[B].label && (a.axisX.labels[c] = t.dataPoints[B].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); null === e ? b.viewPortMin ===
                      c && n < c && (b.viewPortMin = n) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e))
                  }
              ...
              var n = this.data[a.dataSeriesIndexes[m]], q = 0, h = !1, r = !1, g; if ("normal" === n.axisPlacement ||
                "xySwapped" === n.axisPlacement) var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ?
                  this.options.axisX.maximum : Infinity; if (n.dataPoints[q].x && n.dataPoints[q].x.getTime || "dateTime" === n.xValueType) f = !0; for (q = 0; q < n.dataPoints.length; q++) {
                    "undefined" === typeof n.dataPoints[q].x && (n.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0)); n.dataPoints[q].x.getTime ? (f = !0, c = n.dataPoints[q].x.getTime()) : c = n.dataPoints[q].x; e = s(n.dataPoints[q].y) ? 0 : n.dataPoints[q].y; c < b.min && (b.min = c); c > b.max && (b.max = c); if (0 < q) {
                      if (a.axisX.logarithmic) {
                        var x = c / n.dataPoints[q - 1].x; 1 > x && (x = 1 / x); b.minDiff > x && 1 !== x && (b.minDiff =
                          x)
                      } else x = c - n.dataPoints[q - 1].x, 0 > x && (x *= -1), b.minDiff > x && 0 !== x && (b.minDiff = x); null !== e && null !== n.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (x = e / n.dataPoints[q - 1].y, 1 > x && (x = 1 / x), d.minDiff > x && 1 !== x && (d.minDiff = x)) : (x = e - n.dataPoints[q - 1].y, 0 > x && (x *= -1), d.minDiff > x && 0 !== x && (d.minDiff = x)))
                    } if (c < l && !h) null !== n.dataPoints[q].y && (g = c); else {
                      if (!h && (h = !0, 0 < q)) { q -= 2; continue } if (c > u && !r) r = !0; else if (c > u && r) continue; n.dataPoints[q].label && (a.axisX.labels[c] = n.dataPoints[q].label); c < b.viewPortMin && (b.viewPortMin =
                        c); c > b.viewPortMax && (b.viewPortMax = c); null === n.dataPoints[q].y ? b.viewPortMin === c && g < c && (b.viewPortMin = g) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e, a.yAbsTotals[c] = (a.yAbsTotals[c] ? a.yAbsTotals[c] : 0) + Math.abs(e), 0 <= e ? p[c] ? p[c] += e : (p[c] = e, B = Math.min(e, B)) : t[c] ? t[c] += e : (t[c] = e, k = Math.max(e, k)))
                    }
              ...
              var m = this.data[a.dataSeriesIndexes[k]], n = 0, q = !1, h = !1, r; if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var g = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, l = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (m.dataPoints[n].x && m.dataPoints[n].x.getTime || "dateTime" === m.xValueType) f = !0; for (n =
                  0; n < m.dataPoints.length; n++) {
                    "undefined" === typeof m.dataPoints[n].x && (m.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); m.dataPoints[n].x.getTime ? (f = !0, c = m.dataPoints[n].x.getTime()) : c = m.dataPoints[n].x; e = s(m.dataPoints[n].y) ? null : m.dataPoints[n].y; c < b.min && (b.min = c); c > b.max && (b.max = c); if (0 < n) {
                      if (a.axisX.logarithmic) { var u = c / m.dataPoints[n - 1].x; 1 > u && (u = 1 / u); b.minDiff > u && 1 !== u && (b.minDiff = u) } else u = c - m.dataPoints[n - 1].x, 0 > u && (u *= -1), b.minDiff > u && 0 !== u && (b.minDiff = u); s(e) || null === m.dataPoints[n - 1].y ||
                    ...
                    } if (c < g && !q) null !== e && (r = c); else {
                      if (!q && (q = !0, 0 < n)) { n -= 2; continue } if (c > l && !h) h = !0; else if (c > l && h) continue; m.dataPoints[n].label && (a.axisX.labels[c] = m.dataPoints[n].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); null === e ? b.viewPortMin === c && r < c && (b.viewPortMin = r) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] :
                        0) + e, a.yAbsTotals[c] = (a.yAbsTotals[c] ? a.yAbsTotals[c] : 0) + Math.abs(e), 0 <= e ? p = !0 : 0 > e && (t = !0), B[c] = B[c] ? B[c] + Math.abs(e) : Math.abs(e))
                    }
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f, p, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
            ...
            m = 0, n = !1, q = !1, h, r, g; if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
              this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (k.dataPoints[m].x && k.dataPoints[m].x.getTime || "dateTime" === k.xValueType) t = !0; for (m = 0; m < k.dataPoints.length; m++) {
                "undefined" === typeof k.dataPoints[m].x && (k.dataPoints[m].x = m + (a.axisX.logarithmic ? 1 : 0)); k.dataPoints[m].x.getTime ? (t = !0, c = k.dataPoints[m].x.getTime()) : c = k.dataPoints[m].x; if ((e = k.dataPoints[m].y) && e.length) {
                  f = Math.min.apply(null, e); p = Math.max.apply(null, e); r = !0; for (var x =
                    0; x < e.length; x++)null === e.k && (r = !1); r && (n || (g = h), h = c)
                } c < b.min && (b.min = c); c > b.max && (b.max = c); f < d.min && (d.min = f); p > d.max && (d.max = p); 0 < m && (a.axisX.logarithmic ? (r = c / k.dataPoints[m - 1].x, 1 > r && (r = 1 / r), b.minDiff > r && 1 !== r && (b.minDiff = r)) : (r = c - k.dataPoints[m - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[m - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[m - 1].y[0],
          ...
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            var t = this.data[a.dataSeriesIndexes[p]], B = 0, k = !1, m = !1, n = c = 0; if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
                ...
                typeof t.dataPoints[B].isCumulativeSum && !0 === t.dataPoints[B].isCumulativeSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = 0, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[B].isIntermediateSum && !0 === t.dataPoints[B].isIntermediateSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = n, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : c,
                  n = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, c = 0) : (e = "number" !== typeof t.dataPoints[B].y ? 0 : t.dataPoints[B].y, t.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPointEOs[B].cumulativeSum = 0 === B ? e : t.dataPointEOs[B - 1].cumulativeSum + e, c += e); for (B = 0; B < t.dataPoints.length; B++)if ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[B].x.getTime ? (f = !0, c = t.dataPoints[B].x.getTime()) : c = t.dataPoints[B].x, e = t.dataPoints[B].y,
                    c < b.min && (b.min = c), c > b.max && (b.max = c), t.dataPointEOs[B].cumulativeSum < d.min && (d.min = t.dataPointEOs[B].cumulativeSum), t.dataPointEOs[B].cumulativeSum > d.max && (d.max = t.dataPointEOs[B].cumulativeSum), 0 < B && (a.axisX.logarithmic ? (n = c / t.dataPoints[B - 1].x, 1 > n && (n = 1 / n), b.minDiff > n && 1 !== n && (b.minDiff = n)) : (n = c - t.dataPoints[B - 1].x, 0 > n && (n *= -1), b.minDiff > n && 0 !== n && (b.minDiff = n)), null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[B].cumulativeSum / t.dataPointEOs[B - 1].cumulativeSum, 1 > e &&
                      (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[B].cumulativeSum - t.dataPointEOs[B - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(c < q) || k) {
                        if (!k && (k = !0, 0 < B)) { B -= 2; continue } if (c > h && !m) m = !0; else if (c > h && m) continue; t.dataPoints[B].label && (a.axisX.labels[c] = t.dataPoints[B].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); 0 < B && (t.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[B - 1].cumulativeSum), t.dataPointEOs[B -
          ...
          function a(a, c, b, e) {
            if (e) return b = Math.pow(Math.min(b * a / c, c / a), 0.2), 1 >= b && (b = Math.pow(1 > a ? 1 / a : Math.min(c / a, a), 0.25)), {
              startValue: a *
                b, endValue: c / b
            }; b = 0.2 * Math.min(b - c + a, c - a); 0 >= b && (b = 0.25 * Math.min(c - a, Math.abs(a))); return { startValue: a + b, endValue: c - b }
          } function d(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              var c = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, b = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (c || b) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, k = f.min, p = f.max, m = d.min, n = d.max, f = f._dataRanges,
                d = d._dataRanges, q, t = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
                  var g = e.data[a.dataSeriesIndexes[B]]; if (!(4 > g.dataPoints.length)) for (t = 0; t < g.dataPoints.length; t++)if (c && (q = (p + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = g.dataPoints[t].x.getTime ? g.dataPoints[t].x.getTime() : g.dataPoints[t].x, q = Math.floor((h - k) / q), h < f[q].min && (f[q].min = h), h > f[q].max && (f[q].max = h)), b) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges,
              h, k = 0, p = 0; p < a.dataSeriesIndexes.length; p++) { var m = e.data[a.dataSeriesIndexes[p]]; if (!(4 > m.dataPoints.length)) for (k = 0; k < m.dataPoints.length; k++)h = (d + 1 - b) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, c = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, h = Math.floor((c - b) / h), c < f[h].min && (f[h].min = c), c > f[h].max && (f[h].max = c) }
          } for (var c, e = this, f = !1, p = 0; p < this._axes.length; p++)if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
            f =
            ...
            for (p = 0; p < this.plotInfo.plotTypes.length; p++)for (f = this.plotInfo.plotTypes[p], t = 0; t < f.plotUnits.length; t++)c = f.plotUnits[t], "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "bar" === c.type || "bubble" ===
              c.type || "scatter" === c.type || "candlestick" === c.type || "ohlc" === c.type || "rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "waterfall" === c.type || "error" === c.type || "boxAndWhisker" === c.type ? d(c) : 0 <= c.type.indexOf("stacked") && b(c); for (p = 0; p < this._axes.length; p++)if (this._axes[p].dataInfo._dataRanges) {
                var B = this._axes[p].dataInfo.min; c = (this._axes[p].dataInfo.max + 1 - B) * Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var k = this._axes[p].dataInfo._dataRanges,
                  m, n, f = []; if (this._axes[p].dataInfo.dataPointYPositiveSums) { var q = this._axes[p].dataInfo.dataPointYPositiveSums; m = k; for (t in q) if (q.hasOwnProperty(t) && !isNaN(t) && (n = q[t], !s(n))) { var h = Math.floor((n - B) / c); n < m[h].min && (m[h].min = n); n > m[h].max && (m[h].max = n) } delete this._axes[p].dataInfo.dataPointYPositiveSums } if (this._axes[p].dataInfo.dataPointYNegativeSums) {
                    q = this._axes[p].dataInfo.dataPointYNegativeSums; m = k; for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (n = -1 * q[t], s(n) || (h = Math.floor((n - B) / c), n < m[h].min &&
                      (m[h].min = n), n > m[h].max && (m[h].max = n))); delete this._axes[p].dataInfo.dataPointYNegativeSums
                  } for (t = 0; t < k.length - 1; t++)if (m = k[t].max, isFinite(m)) for (; t < k.length - 1;)if (B = k[t + 1].min, isFinite(B)) { n = B - m; n > c && f.push({ diff: n, start: m, end: B }); break } else t++; if (this._axes[p].scaleBreaks.customBreaks) for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++)for (c = 0; c < f.length; c++)if (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[c].start && f[c].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue ||
                    this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[c].start && f[c].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue || f[c].start <= this._axes[p].scaleBreaks.customBreaks[t].startValue && this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[c].end || f[c].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue && this._axes[p].scaleBreaks.customBreaks[t].endValue <= f[c].end) f.splice(c, 1), c--; f.sort(function (a, c) { return c.diff - a.diff }); for (t = 0; t < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); t++)c =
                      a(f[t].start, f[t].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic), this._axes[p].scaleBreaks.autoBreaks.push(new T(this, "autoBreaks", c, t, ++this._eventManager.lastObjectId, this._axes[p].scaleBreaks)), this._axes[p].scaleBreaks._appliedBreaks.push(this._axes[p].scaleBreaks.autoBreaks[this._axes[p].scaleBreaks.autoBreaks.length - 1]); this._axes[p].scaleBreaks._appliedBreaks.sort(function (a,
                        c) { return a.startValue - c.startValue })
              }
          }
          ...
          b = b || !1; for (var c = [], e = this._dataInRenderedOrder.length -
        ...
        l.prototype.clearCanvas = kb; l.prototype.attachEvent = function (a) { this._events.push(a) }; l.prototype._touchEventHandler = function (a) {
          if (a.changedTouches && this.interactivityEnabled) {
            var d = [], b = a.changedTouches, c = b ? b[0] : a, e = null; switch (a.type) {
              case "touchstart": case "MSPointerDown": d = ["mousemove", "mousedown"]; this._lastTouchData = Na(c); this._lastTouchData.time = new Date; break; case "touchmove": case "MSPointerMove": d = ["mousemove"]; break; case "touchend": case "MSPointerUp": var f = this._lastTouchData && this._lastTouchData.time ?
          ...
          var b = { chart: this }; b.type = a; b.trigger =
            d; var c = []; this.axisX && 0 < this.axisX.length && c.push("axisX"); this.axisX2 && 0 < this.axisX2.length && c.push("axisX2"); this.axisY && 0 < this.axisY.length && c.push("axisY"); this.axisY2 && 0 < this.axisY2.length && c.push("axisY2"); for (var e = 0; e < c.length; e++)if (s(b[c[e]]) && (b[c[e]] = []), "axisY" === c[e]) for (var f = 0; f < this.axisY.length; f++)b[c[e]].push({ viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum }); else if ("axisY2" === c[e]) for (f = 0; f <
              this.axisY2.length; f++)b[c[e]].push({ viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum }); else if ("axisX" === c[e]) for (f = 0; f < this.axisX.length; f++)b[c[e]].push({ viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum }); else if ("axisX2" === c[e]) for (f = 0; f < this.axisX2.length; f++)b[c[e]].push({
                viewportMinimum: this[c[e]][f].sessionVariables.newViewportMinimum,
                viewportMaximum: this[c[e]][f].sessionVariables.newViewportMaximum
            ...
            c.chart._mouseEventHandler, !1)), c.hasOwnProperty(b) && ("mouseup" !== b || c.chart.overlaidCanvas.releaseCapture ? a.target !== c.chart.overlaidCanvas && w || c[b].call(c.context, d.x, d.y) : a.target !== c.chart.overlaidCanvas && (c.chart.isDrag = !1))); if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ga && window.console && (window.console.log(b + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which),
              "mouseup" === b && window.console.log("mouseup")), !e) {
                if (!l.capturedEventParam && this._events) {
                  for (var f = 0; f < this._events.length; f++)if (this._events[f].hasOwnProperty(b)) if (c = this._events[f], e = c.bounds, d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                    c[b].call(c.context, d.x, d.y); "mousedown" === b && !0 === c.capture ? (l.capturedEventParam = c, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === b && (c.chart.overlaidCanvas.releaseCapture ?
                ...
                } b = this.plotArea; if (d.x < b.x1 || d.x > b.x2 || d.y < b.y1 || d.y > b.y2) {
          ...
          if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) &&
            this.isDrag) {
              var b = d - this.dragStartPoint.y, c = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), p = !1; this.resetOverlayedCanvas(); if ("xySwapped" === this.plotInfo.axisPlacement) var t = f, f = e, e = t; if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled) for (e = f = 0; e < this._axes.length; e++)b = this._axes[e], b.logarithmic ? b.viewportMinimum < b.minimum ? (f = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * f, b.sessionVariables.newViewportMaximum =
          ...
          if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0, c = 0, e = b = null, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), p = this; "xySwapped" === this.plotInfo.axisPlacement && (b = f, f = e, e = b); b = this.dragStartPoint.x - a; c = this.dragStartPoint.y - d; if (2 < Math.abs(b) && 8 > Math.abs(b) && (this.panEnabled ||
              this.zoomEnabled)) {
            ...
            } else this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, d); if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + b : this.plotArea.x1, y1: f ? this.plotArea.y1 + c : this.plotArea.y1, x2: e ? this.plotArea.x2 + b : this.plotArea.x2, y2: f ? this.plotArea.y2 + c : this.plotArea.y2 }, clearTimeout(p._panTimerId), p._panTimerId = setTimeout(function (c, b, e, f) {
              return function () {
                p._zoomPanToSelectedRegion(c,
              ...
              this.resetOverlayedCanvas(); b = this.overlaidCanvasCtx.globalAlpha; this.overlaidCanvasCtx.fillStyle = "#A89896"; var c = e ? this.dragStartPoint.x : this.plotArea.x1, t = f ? this.dragStartPoint.y : this.plotArea.y1, B = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, k = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1; this.validateRegion(c, t, e ? a : this.plotArea.x2 -
                this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5"); this.overlaidCanvasCtx.globalAlpha = 0.7; this.overlaidCanvasCtx.fillRect(c, t, B, k); this.overlaidCanvasCtx.globalAlpha = b
            }
          ...
          function (a, d, b, c, e) { a = this.validateRegion(a, d, b, c, e); d = a.axesWithValidRange; b = a.axesRanges; if (a.isValid) for (c = 0; c < d.length; c++)e = b[c], d[c].setViewPortRange(e.val1, e.val2), this.syncCharts && "y" != this.zoomType && this.syncCharts(e.val1, e.val2), this.stockChart && (this.stockChart._rangeEventParameter = { stockChart: this.stockChart, source: "chart", index: this.stockChart.charts.indexOf(this), minimum: e.val1, maximum: e.val2 }); return a.isValid }; l.prototype.validateRegion = function (a, d, b, c, e) {
            e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"),
              p = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], m = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && f || "axisY" === this._axes[n].type && p) && k.push(this._axes[n]); for (p = 0; p < k.length; p++) {
                var n = k[p], f = !1, q = n.convertPixelToValue({ x: a, y: d }), h = n.convertPixelToValue({ x: b, y: c }); if (q > h) var r = h, h = q, q = r; if (n.scaleBreaks) for (r = 0; !f && r < n.scaleBreaks._appliedBreaks.length; r++)f = n.scaleBreaks._appliedBreaks[r].startValue <= q && n.scaleBreaks._appliedBreaks[r].endValue >= h; if (isFinite(n.dataInfo.minDiff)) if (r =
            ...
            var a = this.plotArea; !w && (0 < a.x1 || 0 < a.y1) && a.ctx.translate(a.x1, a.y1); if ((this.axisX[0] || this.axisX2[0]) &&
              (this.axisY[0] || this.axisY2[0])) {
                var d = this.axisX[0] ? this.axisX[0].lineCoordinates : this.axisX2[0].lineCoordinates; if (this.axisY && 0 < this.axisY.length && this.axisY[0]) { var b = this.axisY[0]; a.x1 = d.x1 < d.x2 ? d.x1 : b.lineCoordinates.x1; a.y1 = d.y1 < b.lineCoordinates.y1 ? d.y1 : b.lineCoordinates.y1; a.x2 = d.x2 > b.lineCoordinates.x2 ? d.x2 : b.lineCoordinates.x2; a.y2 = d.y2 > d.y1 ? d.y2 : b.lineCoordinates.y2; a.width = a.x2 - a.x1; a.height = a.y2 - a.y1 } this.axisY2 && 0 < this.axisY2.length && this.axisY2[0] && (b = this.axisY2[0], a.x1 = d.x1 < d.x2 ?
                  d.x1 : b.lineCoordinates.x1, a.y1 = d.y1 < b.lineCoordinates.y1 ? d.y1 : b.lineCoordinates.y1, a.x2 = d.x2 > b.lineCoordinates.x2 ? d.x2 : b.lineCoordinates.x2, a.y2 = d.y2 > d.y1 ? d.y2 : b.lineCoordinates.y2, a.width = a.x2 - a.x1, a.height = a.y2 - a.y1)
            ...
            var d = a || this.plotArea.ctx, b = this.plotArea, c = 0, e = 0, f = 0, p = f = e = 0, t = 0, B = c = 0, k = 0; for (a = 0; a < this._indexLabels.length; a++) {
                    ...
                    this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(C) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null; if (null !== D && "" !== D) {
                      ...
                      f = m.dataSeries.axisY, y = !1, g = new ia(d, { x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: h ? 5 * r : 1.5 * r, angle: "horizontal" === C ? 0 : -90, text: D, padding: 0, backgroundColor: g, textAlign: z, fontSize: r, fontFamily: t, fontWeight: k, fontColor: p, fontStyle: B, textBaseline: "middle" }); g.measureText(); m.dataSeries.indexLabelMaxWidth = g.maxWidth; if ("stackedarea100" === n) { if (m.point.x < b.x1 || m.point.x > b.x2 || m.point.y < b.y1 - 1 || m.point.y > b.y2 + 1) continue } else if ("rangearea" === n || "rangesplinearea" === n) {
                        ...
                        e.viewportMaximum) continue; p = t = 2; "horizontal" === C ? (B = g.width, k = g.height) : (k = g.width, B = g.height); if ("normal" === this.plotInfo.axisPlacement) {
                          if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) A = "auto", t = 4; else if (0 <= n.indexOf("stacked")) "auto" === A && (A = "inside"); else if ("bubble" === n || "scatter" === n) A = "inside"; q = m.point.x - ("horizontal" === C ? B / 2 : B / 2 - r / 2); "inside" !== A ? (e = b.y1, f = b.y2, 0 < v ? (h = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - c, h < e && (h = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t, y = h + k > m.point.y)) : (h = m.point.y +
                            r / 2 + t + c, h > f - k && (h = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k, y = h < m.point.y))) : (e = Math.max(m.bounds.y1, b.y1), f = Math.min(m.bounds.y2, b.y2 - k + r / 2), c = 0 <= n.indexOf("range") || "error" === n ? 0 < v ? Math.max(m.bounds.y1, b.y1) + r / 2 + t : Math.min(m.bounds.y2, b.y2) + r / 2 - k + t : (Math.max(m.bounds.y1, b.y1) + Math.min(m.bounds.y2, b.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === C ? t : 0), 0 < v ? (h = Math.max(m.point.y, c), h < e && ("bubble" === n || "scatter" === n) && (h = Math.max(m.point.y - k - t, b.y1 + t))) : (h = Math.min(m.point.y, c), h > f - k - t && ("bubble" === n || "scatter" ===
                              n) && (h = Math.min(m.point.y + t, b.y2 - k - t))), h = Math.min(h, f))
                        } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (A = "auto", p = 4) : 0 <= n.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === n && (A = "inside"), h = m.point.y + r / 2 - k / 2 + t, "inside" !== A ? (e = b.x1, f = b.x2, 0 > v ? (q = m.point.x - ("horizontal" === C ? B : B - r / 2) - p - c, q < e && (q = "auto" === A ? Math.max(m.point.x, e) + p : e + p, y = q + B > m.point.x)) : (q = m.point.x + ("horizontal" === C ? 0 : r / 2) + p + c, q > f - B - p - c && (q = "auto" === A ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - p : f -
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = this._eventManager.ghostCtx; b.save(); var e = this.plotArea; b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                var B = a.dataSeriesIndexes[t], k = this.data[B]; b.lineWidth = k.lineThickness; var m = k.dataPoints, n = "solid"; if (b.setLineDash) {
                  var q = N(k.nullDataLineDashType, k.lineThickness), n = k.lineDashType,
                  h = N(n, k.lineThickness); b.setLineDash(h)
                } var r = k.id; this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: B }; r = P(r); c.strokeStyle = r; c.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var r = k._colorSet, g = r = k.lineColor = k.options.lineColor ? k.options.lineColor : r[0]; b.strokeStyle = r; var l = !0, u = 0, x, s; b.beginPath(); if (0 < m.length) {
                  for (var C = !1, u = 0; u < m.length; u++)if (x = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                    !C))) if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (b.stroke(), w && c.stroke()), C = !0; else {
                      x = a.axisX.convertValueToPixel(x); s = a.axisY.convertValueToPixel(m[u].y); var D = k.dataPointIds[u]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: x, y1: s }; l || C ? (!l && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(p.x, p.y), n = k.nullDataLineDashType,
                        b.setLineDash(q)), b.lineTo(x, s), w && c.lineTo(x, s)) : (b.beginPath(), b.moveTo(x, s), w && (c.beginPath(), c.moveTo(x, s))), C = l = !1) : (b.lineTo(x, s), w && c.lineTo(x, s), 0 == u % 500 && (b.stroke(), b.beginPath(), b.moveTo(x, s), w && (c.stroke(), c.beginPath(), c.moveTo(x, s)))); p = { x: x, y: s }; u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (b.stroke(), b.beginPath(), b.moveTo(x, s), g = m[u].lineColor || r, b.strokeStyle = g, b.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, b.setLineDash(N(n, k.lineThickness))) :
                          (n = k.lineDashType, b.setLineDash(h)))); if (0 < m[u].markerSize || 0 < k.markerSize) { var z = k.getMarkerProperties(u, x, s, b); f.push(z); D = P(D); w && f.push({ x: x, y: s, ctx: c, type: z.type, size: z.size, color: D, borderColor: D, borderThickness: z.borderThickness }) } (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: x, y: s }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r })
                    } b.stroke(); w && c.stroke()
                }
              } V.drawMarkers(f); w &&
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = this._eventManager.ghostCtx; b.save(); var e = this.plotArea; b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                var B = a.dataSeriesIndexes[t], k = this.data[B]; b.lineWidth = k.lineThickness; var m = k.dataPoints, n = "solid"; if (b.setLineDash) {
                  var q = N(k.nullDataLineDashType,
                    k.lineThickness), n = k.lineDashType, h = N(n, k.lineThickness); b.setLineDash(h)
                } var r = k.id; this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: B }; r = P(r); c.strokeStyle = r; c.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var r = k._colorSet, g = r = k.lineColor = k.options.lineColor ? k.options.lineColor : r[0]; b.strokeStyle = r; var l = !0, u = 0, x, s; b.beginPath(); if (0 < m.length) {
                  for (var C = !1, u = 0; u < m.length; u++)if (x = m[u].getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !C))) if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (b.stroke(), w && c.stroke()), C = !0; else {
                      var D = s; x = a.axisX.convertValueToPixel(x); s = a.axisY.convertValueToPixel(m[u].y); var z = k.dataPointIds[u]; this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: x, y1: s }; l || C ? (!l && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(p.x,
                        p.y), n = k.nullDataLineDashType, b.setLineDash(q)), b.lineTo(x, D), b.lineTo(x, s), w && (c.lineTo(x, D), c.lineTo(x, s))) : (b.beginPath(), b.moveTo(x, s), w && (c.beginPath(), c.moveTo(x, s))), C = l = !1) : (b.lineTo(x, D), w && c.lineTo(x, D), b.lineTo(x, s), w && c.lineTo(x, s), 0 == u % 500 && (b.stroke(), b.beginPath(), b.moveTo(x, s), w && (c.stroke(), c.beginPath(), c.moveTo(x, s)))); p = { x: x, y: s }; u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (b.stroke(), b.beginPath(), b.moveTo(x, s), g = m[u].lineColor || r, b.strokeStyle =
                          g, b.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, b.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, b.setLineDash(h)))); if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, x, s, b), f.push(D), z = P(z), w && f.push({ x: x, y: s, ctx: c, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness }); (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
              ...
              b.restore(); b.beginPath(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
            }
          }; l.prototype.renderSpline = function (a) {
            function d(a) {
              a = v(a, 2); if (0 < a.length) {
                c.beginPath(); w && e.beginPath(); c.moveTo(a[0].x, a[0].y); a[0].newStrokeStyle && (c.strokeStyle = a[0].newStrokeStyle); a[0].newLineDashArray && c.setLineDash(a[0].newLineDashArray); w && e.moveTo(a[0].x, a[0].y); for (var b = 0; b < a.length - 3; b += 3)if (c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b +
            ...
            } var b = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e =
                this._eventManager.ghostCtx; c.save(); var f = this.plotArea; c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); for (var p = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
              ...
              w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), e.beginPath()); c.restore(); c.beginPath(); return {
                source: b, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation,
                easingFunction: K.easing.linear, animationBase: 0
              }
            }
                  ...
                  m < f) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); n < f && (n = f); n > m && (n = m); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var q = a.dataSeriesIndexes[m], h = this.data[q], r = h.dataPoints; if (0 < r.length) for (var g = 5 < n && h.bevelEnabled ? !0 : !1, f =
                      0; f < r.length; f++)if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                        p = a.axisX.convertValueToPixel(B); t = a.axisY.convertValueToPixel(r[f].y); p = a.axisX.reversed ? p + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + m) * n << 0 : p - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + m) * n << 0; var l = a.axisX.reversed ? p - n << 0 : p + n << 0, u; 0 <= r[f].y ? u = k : (u = t, t = k); t > u && (c = t, t = u, u = c); c = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length];
                        ca(b, p, t, l, u, c, 0, null, g && 0 <= r[f].y, 0 > r[f].y && g, !1, !1, h.fillOpacity); c = h.dataPointIds[f]; this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: p, y1: t, x2: l, y2: u }; c = P(c); w && ca(this._eventManager.ghostCtx, p, t, l, u, c, 0, null, !1, !1, !1, !1); (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                          chartType: "column", dataPoint: r[f], dataSeries: h, point: { x: p + (l - p) / 2, y: 0 > r[f].y === a.axisY.reversed ? t : u }, direction: 0 > r[f].y ===
                            a.axisY.reversed ? 1 : -1, bounds: { x1: p, y1: Math.min(t, u), x2: l, y2: Math.max(t, u) }, color: c
                        })
                      }
                  } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
              b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.yScaleAnimation, easingFunction: K.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k }
            }
                  ...
                  k > m && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m)); !this.dataPointMaxWidth && (this.dataPointMinWidth && m < k) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); h < k && (h = k); h > m && (h = m); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var g =
                      a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints; if (0 < u.length) {
                        var x = 5 < h && l.bevelEnabled ? !0 : !1; b.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                          m = a.axisX.convertValueToPixel(c); var s = m - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, C = s + h << 0, D; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[c] = u[k].y + (t[c] ? t[c] :
                          ...
                          ca(b, s, n, C, D, c, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, l.fillOpacity); c = l.dataPointIds[k]; this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: s, y1: n, x2: C, y2: D }; c = P(c); w && ca(this._eventManager.ghostCtx, s, n, C, D, c, 0, null, !1, !1, !1, !1); (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stackedColumn", dataPoint: u[k], dataSeries: l, point: { x: m, y: 0 <= u[k].y ? n : D }, direction: 0 > u[k].y === a.axisY.reversed ?
                              1 : -1, bounds: { x1: s, y1: Math.min(n, D), x2: C, y2: Math.max(n, D) }, color: c
                          })
                        }
                      }
                  } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
              b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.yScaleAnimation, easingFunction: K.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
            }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0; var h = a.axisX.dataInfo.minDiff; isFinite(h) || (h = 0.3 * Math.abs(a.axisX.range)); h = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth &&
                k > m && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m)); !this.dataPointMaxWidth && (this.dataPointMinWidth && m < k) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); h < k && (h = k); h > m && (h = m); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                  var g =
                    a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints; if (0 < u.length) for (var x = 5 < h && l.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                      m = a.axisX.convertValueToPixel(c); n = 0 !== a.dataPointYSums[c] ? 100 * (u[k].y / a.dataPointYSums[c]) : 0; var s = m - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, C = s + h << 0, D; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                        0 < u[k].y) { t[c] = n + ("undefined" !== typeof t[c] ? t[c] : 0); if (0 >= t[c]) continue; n = a.axisY.convertValueToPixel(t[c]); D = f[c] ? f[c] : q; f[c] = n } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = n + ("undefined" !== typeof B[c] ? B[c] : 0), D = a.axisY.convertValueToPixel(B[c]), n = p[c] ? p[c] : q, p[c] = D; else if (n = a.axisY.convertValueToPixel(n), 0 <= u[k].y) { var z = "undefined" !== typeof f[c] ? f[c] : 0; n -= z; D = q - z; a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y1 - n) && (n = e.y1); f[c] = z + (D - n) } else z = "undefined" !==
                          typeof p[c] ? p[c] : 0, D = n + z, n = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), p[c] = z + (D - n); c = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length]; ca(b, s, n, C, D, c, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, l.fillOpacity); c = l.dataPointIds[k]; this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: s, y1: n, x2: C, y2: D }; c = P(c); w && ca(this._eventManager.ghostCtx, s, n, C, D, c, 0, null, !1, !1, !1, !1); (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) &&
                            this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: u[k], dataSeries: l, point: { x: m, y: 0 <= u[k].y ? n : D }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: s, y1: Math.min(n, D), x2: C, y2: Math.max(n, D) }, color: c })
                    }
                } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                  this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.yScaleAnimation, easingFunction: K.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
            }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var q = a.dataSeriesIndexes[m], h = this.data[q], r = h.dataPoints; if (0 < r.length) {
                  var g = 5 < n && h.bevelEnabled ? !0 : !1; b.strokeStyle = "#4572A7 "; for (f = 0; f < r.length; f++)if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                    ...
                    p = a.axisY.convertValueToPixel(r[f].y); t = a.axisX.reversed ? t + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + m) * n << 0 : t - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + m) * n << 0; var l = a.axisX.reversed ? t - n << 0 : t + n << 0, u; 0 <= r[f].y ? u = k : (u = p, p = k); c = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length]; ca(b, u, t, p, l, c, 0, null, g, !1, !1, !1, h.fillOpacity); c = h.dataPointIds[f]; this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: t, x2: p, y2: l }; c =
                      P(c); w && ca(this._eventManager.ghostCtx, u, t, p, l, c, 0, null, !1, !1, !1, !1); (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[f], dataSeries: h, point: { x: 0 <= r[f].y ? p : u, y: t + (l - t) / 2 }, direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, p), y1: t, x2: Math.max(u, p), y2: l }, color: c })
                  }
                }
              } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas,
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = null, e = this.plotArea, f = [], p = [], t = [], B = [], k = 0, m, n, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height <<
                0; var h = a.axisX.dataInfo.minDiff; isFinite(h) || (h = 0.3 * Math.abs(a.axisX.range)); h = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > n && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); h <
                  k && (h = k); h > n && (h = n); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var g = a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints; if (0 < u.length) {
                      var x = 5 < h && l.bevelEnabled ? !0 : !1; b.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() :
                        u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                          n = a.axisX.convertValueToPixel(c); var s = n - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, C = s + h << 0, D; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[c] = u[k].y + (t[c] ? t[c] : 0), 0 < t[c] && (D = f[c] ? f[c] : q, f[c] = m = a.axisY.convertValueToPixel(t[c])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = u[k].y + (B[c] ? B[c] : 0), m = p[c] ?
                            p[c] : q, p[c] = D = a.axisY.convertValueToPixel(B[c]); else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) { var z = f[c] ? f[c] : 0; D = q + z; m += z; f[c] = z + (m - D) } else z = p[c] ? p[c] : 0, D = m - z, m = q - z, p[c] = z + (m - D); c = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length]; ca(b, D, s, m, C, c, 0, null, x, !1, !1, !1, l.fillOpacity); c = l.dataPointIds[k]; this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: D, y1: s, x2: m, y2: C }; c = P(c); w && ca(this._eventManager.ghostCtx, D, s, m, C, c, 0, null, !1, !1, !1,
                              !1); (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: u[k], dataSeries: l, point: { x: 0 <= u[k].y ? m : D, y: n }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(D, m), y1: s, x2: Math.max(D, m), y2: C }, color: c })
                      }
                    }
                  } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
                    b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.xScaleAnimation, easingFunction: K.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q }
            }
          }; l.prototype.renderStackedBar100 = function (a) {
            var d =
              a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                  var g = a.dataSeriesIndexes[r], l = this.data[g], u = l.dataPoints; if (0 < u.length) {
                    var s = 5 < h && l.bevelEnabled ? !0 : !1; b.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                      "number" === typeof u[k].y) {
                        n = a.axisX.convertValueToPixel(c); var A; A = 0 !== a.dataPointYSums[c] ? 100 * (u[k].y / a.dataPointYSums[c]) : 0; var C = n - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, D = C + h << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) { t[c] = A + (t[c] ? t[c] : 0); if (0 >= t[c]) continue; A = f[c] ? f[c] : q; f[c] = m = a.axisY.convertValueToPixel(t[c]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[c] = A + (B[c] ? B[c] : 0), m = p[c] ? p[c] :
                          q, p[c] = A = a.axisY.convertValueToPixel(B[c]); else if (m = a.axisY.convertValueToPixel(A), 0 <= u[k].y) { var z = f[c] ? f[c] : 0; A = q + z; m += z; a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x2 - m) && (m = e.x2); f[c] = z + (m - A) } else z = p[c] ? p[c] : 0, A = m - z, m = q - z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - A) && (A = e.x1), p[c] = z + (m - A); c = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length]; ca(b, A, C, m, D, c, 0, null, s, !1, !1, !1, l.fillOpacity); c = l.dataPointIds[k]; this._eventManager.objectMap[c] = {
                            id: c, objectType: "dataPoint", dataSeriesIndex: g,
                            dataPointIndex: k, x1: A, y1: C, x2: m, y2: D
                          }; c = P(c); w && ca(this._eventManager.ghostCtx, A, C, m, D, c, 0, null, !1, !1, !1, !1); (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: l, point: { x: 0 <= u[k].y ? m : A, y: n }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(A, m), y1: C, x2: Math.max(A, m), y2: D }, color: c })
                    }
                  }
                } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop",
              ...
              var p = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, B = [], k = this.plotArea, m; f.save(); w && p.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); w && (p.beginPath(), p.rect(k.x1, k.y1, k.width, k.height), p.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                B = P(B); p.fillStyle = B; B = []; d = !0; var g = 0, l, u, s, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), C, D = null; if (0 < r.length) {
                  var z = h._colorSet[g % h._colorSet.length], v = h.lineColor = h.options.lineColor || z, y = v; f.fillStyle = z; f.strokeStyle = v; f.lineWidth = h.lineThickness; b = "solid"; if (f.setLineDash) { var Q = N(h.nullDataLineDashType, h.lineThickness); b = h.lineDashType; var aa = N(b, h.lineThickness); f.setLineDash(aa) } for (var ja = !0; g < r.length; g++)if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s <
                    a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ja))) if ("number" !== typeof r[g].y) h.connectNullData || (ja || d) || c(), ja = !0; else {
                      l = a.axisX.convertValueToPixel(s); u = a.axisY.convertValueToPixel(r[g].y); d || ja ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || b === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, b = u, l = m.x, u = m.y, c(), f.moveTo(m.x, m.y), l = d, u = b, D = m, b = h.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(l, u), w && p.lineTo(l, u)) :
            ...
            function d() {
              var b = v(s, 2); if (0 < b.length) {
                ...
                } c.beginPath(); c.moveTo(b[0].x, b[0].y); w && (e.beginPath(), e.moveTo(b[0].x, b[0].y)); for (d = 0; d < b.length - 3; d += 3)c.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), w && e.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y); a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                  l = g : 0 > a.axisY.viewportMaximum ? l = f.y1 : 0 < a.axisY.viewportMinimum && (l = g); u = { x: b[0].x, y: b[0].y }; c.lineTo(b[b.length - 1].x, l); c.lineTo(u.x, l); c.closePath(); c.globalAlpha = m.fillOpacity; c.fill(); c.globalAlpha = 1; w && (e.lineTo(b[b.length - 1].x, l), e.lineTo(u.x, l), e.closePath(), e.fill())
              }
            } var b = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, p = [], t = this.plotArea; c.save(); w && e.save(); c.beginPath(); c.rect(t.x1,
                t.y1, t.width, t.height); c.clip(); w && (e.beginPath(), e.rect(t.x1, t.y1, t.width, t.height), e.clip()); for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                      ...
                      A, D = C; c.fillStyle = A; c.strokeStyle = C; c.lineWidth = m.lineThickness; var z = "solid"; if (c.setLineDash) { var y = N(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, E = N(z, m.lineThickness); c.setLineDash(E) } for (r = !1; q < n.length; q++)if (h = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r))) if ("number" !== typeof n[q].y) 0 < q && !r && (m.connectNullData ? c.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !n[q - 1].lineDashType)) &&
                        (s[s.length - 1].newLineDashArray = y, z = m.nullDataLineDashType) : (d(), s = [])), r = !0; else {
                          h = a.axisX.convertValueToPixel(h); r = a.axisY.convertValueToPixel(n[q].y); var Q = m.dataPointIds[q]; this._eventManager.objectMap[Q] = { id: Q, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: h, y1: r }; s[s.length] = { x: h, y: r }; q < n.length - 1 && (D !== (n[q].lineColor || C) || z !== (n[q].lineDashType || m.lineDashType)) && (D = n[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, c.setLineDash && (n[q].lineDashType ? (z = n[q].lineDashType, s[s.length -
                            1].newLineDashArray = N(z, m.lineThickness)) : (z = m.lineDashType, s[s.length - 1].newLineDashArray = E))); if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < m.markerSize)) { var aa = m.getMarkerProperties(q, h, r, c); p.push(aa); Q = P(Q); w && p.push({ x: h, y: r, ctx: e, type: aa.type, size: aa.size, color: Q, borderColor: Q, borderThickness: aa.borderThickness }) } (n[q].indexLabel || m.indexLabel || n[q].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
              ...
              c.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
            }
            ...
            var d, b; function c() {
              ...
              var p = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, B = [], k = this.plotArea, m; f.save(); w && p.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); w && (p.beginPath(), p.rect(k.x1, k.y1, k.width, k.height), p.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                h = this.data[q], r = h.dataPoints, B = h.id; this._eventManager.objectMap[B] = { objectType: "dataSeries", dataSeriesIndex: q }; B = P(B); p.fillStyle = B; B = []; d = !0; var g = 0, l, u, s, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), C, D = null; b = !1; if (0 < r.length) {
                  ...
                  } for (; g < r.length; g++)if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !b))) {
                    var Y = u; "number" !== typeof r[g].y ? (h.connectNullData || (b || d) || c(), b = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(r[g].y), d || b ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || Q === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, b = u, l = m.x, u = m.y, c(),
            ...
            function d() { if (!(1 > k.length)) { for (0 < z.lineThickness && c.stroke(); 0 < k.length;) { var a = k.pop(); c.lineTo(a.x, a.y); w && s.lineTo(a.x, a.y) } c.closePath(); c.globalAlpha = z.fillOpacity; c.fill(); c.globalAlpha = 1; c.beginPath(); w && (s.closePath(), s.fill(), s.beginPath()); k = [] } } var b =
              a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = [], t = this.plotArea, g = [], k = [], m = [], n = [], q = 0, h, r, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, u, x, A; w && s.beginPath(); c.save(); w && s.save(); c.beginPath(); c.rect(t.x1, t.y1, t.width, t.height); c.clip(); w && (s.beginPath(), s.rect(t.x1, t.y1, t.width, t.height), s.clip()); for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                  ...
                  D = a.dataSeriesIndexes[C]; z = this.data[D]; v = z.dataPoints; x = !0; k = []; q = z.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: D }; q = P(q); s.fillStyle = q; if (0 < m.length) {
                    var e = z._colorSet[0], y = z.lineColor = z.options.lineColor || e, Q = y; c.fillStyle = e; c.strokeStyle = y; c.lineWidth =
                      z.lineThickness; A = "solid"; if (c.setLineDash) { var aa = N(z.nullDataLineDashType, z.lineThickness); A = z.lineDashType; var E = N(A, z.lineThickness); c.setLineDash(E) } for (var Y = !0, q = 0; q < m.length; q++) {
                      ...
                      } d(); c.moveTo(h, r); w && s.moveTo(h, r)
                  } delete z.dataPointIndexes
                } V.drawMarkers(p); w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                  this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(t.x1, t.y1, t.width, t.height), s.restore()); c.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
              }
          }; l.prototype.renderStackedArea100 = function (a) {
            function d() {
              for (0 < z.lineThickness && c.stroke(); 0 < k.length;) { var a = k.pop(); c.lineTo(a.x, a.y); w && A.lineTo(a.x, a.y) } c.closePath(); c.globalAlpha = z.fillOpacity; c.fill();
              c.globalAlpha = 1; c.beginPath(); w && (A.closePath(), A.fill(), A.beginPath()); k = []
            } var b = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, p = this.plotArea, t = [], g = [], k = [], m = [], n = [], q = 0, h, r, l, s, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), A = this._eventManager.ghostCtx; c.save(); w && A.save(); c.beginPath(); c.rect(p.x1, p.y1, p.width, p.height); c.clip(); w && (A.beginPath(), A.rect(p.x1, p.y1, p.width, p.height), A.clip());
              for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) { var v = a.dataSeriesIndexes[C], z = this.data[v], y = z.dataPoints; z.dataPointIndexes = []; for (q = 0; q < y.length; q++)v = y[q].x.getTime ? y[q].x.getTime() : y[q].x, z.dataPointIndexes[v] = q, e[v] || (m.push(v), e[v] = !0); m.sort(Pa) } for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                v = a.dataSeriesIndexes[C]; z = this.data[v]; y = z.dataPoints; s = !0; e = z.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: v }; e = P(e); A.fillStyle = e; k = []; if (0 < m.length) {
                  var e = z._colorSet[q %
                    z._colorSet.length], E = z.lineColor = z.options.lineColor || e, Q = E; c.fillStyle = e; c.strokeStyle = E; c.lineWidth = z.lineThickness; u = "solid"; if (c.setLineDash) { var aa = N(z.nullDataLineDashType, z.lineThickness); u = z.lineDashType; var F = N(u, z.lineThickness); c.setLineDash(F) } for (var Y = !0, q = 0; q < m.length; q++) {
                      var f = m[q], fa = null, fa = 0 <= z.dataPointIndexes[f] ? y[z.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y))) if ("number" !== typeof fa.y) z.connectNullData ||
                        (Y || s) || d(), Y = !0; else {
                          var ma; ma = 0 !== a.dataPointYSums[f] ? 100 * (fa.y / a.dataPointYSums[f]) : 0; h = a.axisX.convertValueToPixel(f); var ba = g[f] ? g[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { n[f] = ma + (n[f] ? n[f] : 0); if (0 >= n[f] && a.axisY.logarithmic) continue; r = a.axisY.convertValueToPixel(n[f]) } else r = a.axisY.convertValueToPixel(ma), r -= ba; k.push({ x: h, y: x - ba }); g[f] = x - r; s || Y ? (!s && z.connectNullData ? (c.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType &&
                            z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), c.moveTo(l.x, l.y), k.push(u), k.push(s), u = z.nullDataLineDashType, c.setLineDash(aa)), c.lineTo(h, r), w && A.lineTo(h, r)) : (c.beginPath(), c.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))), Y = s = !1) : (c.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), c.moveTo(h, r), w && A.moveTo(h, r), k.push({ x: h, y: x - ba }))); l = { x: h, y: r }; q < y.length - 1 && (Q !== (y[q].lineColor || E) || u !== (y[q].lineDashType || z.lineDashType)) && (d(), c.beginPath(), c.moveTo(h, r), k.push({
                              x: h, y: x -
                                ba
                    ...
                    } d(); c.moveTo(h, r); w && A.moveTo(h, r)
                } delete z.dataPointIndexes
              } V.drawMarkers(t); w && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation =
                "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(p.x1, p.y1, p.width, p.height), A.restore()); c.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
            }
                ...
                var c = this.plotArea, e = 0, f, p; b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(c.x1, c.y1, c.width, c.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (var t = -Infinity, g = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var m = a.dataSeriesIndexes[k], n = this.data[m], q = n.dataPoints,
                  h = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (h = q[e].z, h > t && (t = h), h < g && (g = h)); for (var r = 25 * Math.PI, l = Math.max(Math.pow(0.25 * Math.min(c.height, c.width) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)if (m = a.dataSeriesIndexes[k], n = this.data[m], q = n.dataPoints, 0 < q.length) for (b.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                    f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                      f = a.axisX.convertValueToPixel(f); p = a.axisY.convertValueToPixel(q[e].y); var h = q[e].z, s = 2 * Math.max(Math.sqrt((t === g ? l / 2 : r + (l - r) / (t - g) * (h - g)) / Math.PI) << 0, 1), h = n.getMarkerProperties(e, b); h.size = s; b.globalAlpha = n.fillOpacity; V.drawMarker(f, p, b, h.type, h.size, h.color, h.borderColor, h.borderThickness); b.globalAlpha = 1; var u = n.dataPointIds[e]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: e, x1: f, y1: p, size: s };
                    ...
                    0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
              }
          }; l.prototype.renderScatter = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx,
            b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = this.plotArea, e = 0, f, p; b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(c.x1, c.y1, c.width, c.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                var g = a.dataSeriesIndexes[t], k = this.data[g], m = k.dataPoints; if (0 < m.length) {
                  b.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(c.height,
                    c.width) / 2, 2); for (var n = 0, q = 0, e = 0; e < m.length; e++)if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                      f = a.axisX.convertValueToPixel(f); p = a.axisY.convertValueToPixel(m[e].y); var h = k.getMarkerProperties(e, f, p, b); b.globalAlpha = k.fillOpacity; V.drawMarker(h.x, h.y, h.ctx, h.type, h.size, h.color, h.borderColor, h.borderThickness); b.globalAlpha = 1; Math.sqrt((n - f) * (n - f) + (q - p) * (q - p)) < Math.min(h.size, 5) && m.length > Math.min(this.plotArea.width,
              ...
              } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.restore()); b.restore(); return {
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d, c = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, p = this.plotArea, t = 0, g, k, m, n, q, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * p.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > f && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f)); !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); r <
                  e && (r = e); r > f && (r = f); b.save(); w && c.save(); b.beginPath(); b.rect(p.x1, p.y1, p.width, p.height); b.clip(); w && (c.beginPath(), c.rect(p.x1, p.y1, p.width, p.height), c.clip()); for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                  ...
                  } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), c.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
            }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d, c = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              p = 0, t, g, k, m, n, q, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e >
                p && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < e) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); r < e && (r = e); r > p && (r = p); b.save(); w && c.save(); b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); w && (c.beginPath(), c.rect(f.x1, f.y1, f.width, f.height), c.clip()); for (var l = !1, l = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                  ...
                  if (0 < A.length) for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++)if (A[p].getTime ? h = A[p].x.getTime() : h = A[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(A[p].y) && A[p].y.length && "number" === typeof A[p].y[0] && "number" === typeof A[p].y[1] && "number" === typeof A[p].y[2] && "number" === typeof A[p].y[3] && "number" === typeof A[p].y[4] && 5 === A[p].y.length) {
                    ...
                    n = a.axisY.convertValueToPixel(A[p].y[3]); q = a.axisY.convertValueToPixel(A[p].y[4]); var D = t - r / 2 << 0, z = t + r / 2 << 0, e = A[p].color ? A[p].color : x._colorSet[0], y = Math.round(Math.max(1, 0.15 * r)), E = 0 === y % 2 ? 0 : 0.5, Q = A[p].whiskerColor ? A[p].whiskerColor : A[p].color ? x.whiskerColor ? x.whiskerColor : A[p].color : x.whiskerColor ? x.whiskerColor : e, aa = "number" === typeof A[p].whiskerThickness ? A[p].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : y, F = A[p].whiskerDashType ? A[p].whiskerDashType : x.whiskerDashType,
                      Y = s(A[p].whiskerLength) ? s(x.options.whiskerLength) ? r : x.whiskerLength : A[p].whiskerLength, Y = "number" === typeof Y ? 0 >= Y ? 0 : Y >= r ? r : Y : "string" === typeof Y ? parseInt(Y) * r / 100 > r ? r : parseInt(Y) * r / 100 : r, fa = 1 === Math.round(aa) % 2 ? 0.5 : 0, ma = A[p].stemColor ? A[p].stemColor : A[p].color ? x.stemColor ? x.stemColor : A[p].color : x.stemColor ? x.stemColor : e, ba = "number" === typeof A[p].stemThickness ? A[p].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : y, G = 1 === Math.round(ba) % 2 ? 0.5 : 0, J = A[p].stemDashType ? A[p].stemDashType :
                        ...
                        }; b.save(); 0 < ba && (b.beginPath(), b.strokeStyle = ma, b.lineWidth = ba, b.setLineDash && b.setLineDash(N(J, ba)), b.moveTo(t - G, k), b.lineTo(t - G, g), b.stroke(), b.moveTo(t - G, n), b.lineTo(t - G, m), b.stroke()); b.restore(); c.lineWidth = Math.max(y, 4); b.beginPath(); ca(b, D, Math.min(q, k), z, Math.max(k, q), xa, 0, e, l ? C : !1, l ? !1 : C, !1, !1, sa); b.beginPath();
                  ...
                  0, 0, this.width, this.height), b.clearRect(f.x1, f.y1, f.width, f.height), c.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
            }
          }; l.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = null, e = this.plotArea, f = 0, p, t, g, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                  ...
                  (this.dataPointMinWidth && p < f) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); k < f && (k = f); k > p && (k = p); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n = a.dataSeriesIndexes[m], q = this.data[n], h = q.dataPoints; if (0 < h.length) for (var r =
                      5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++)if (h[f].getTime ? g = h[f].x.getTime() : g = h[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                        c = a.axisX.convertValueToPixel(g); p = a.axisY.convertValueToPixel(h[f].y[0]); t = a.axisY.convertValueToPixel(h[f].y[1]); var l = a.axisX.reversed ? c + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : c - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                          m) * k << 0, v = a.axisX.reversed ? l - k << 0 : l + k << 0, c = h[f].color ? h[f].color : q._colorSet[f % q._colorSet.length]; if (p > t) { var u = p; p = t; t = u } u = q.dataPointIds[f]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: l, y1: p, x2: v, y2: t }; ca(b, l, p, v, t, c, 0, c, r, r, !1, !1, q.fillOpacity); c = P(u); w && ca(this._eventManager.ghostCtx, l, p, v, t, c, 0, null, !1, !1, !1, !1); if (h[f].indexLabel || q.indexLabel || h[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                            chartType: "rangeColumn",
                            dataPoint: h[f], dataSeries: q, indexKeyword: 0, point: { x: l + (v - l) / 2, y: h[f].y[1] >= h[f].y[0] ? t : p }, direction: h[f].y[1] >= h[f].y[0] ? -1 : 1, bounds: { x1: l, y1: Math.min(p, t), x2: v, y2: Math.max(p, t) }, color: c
                          }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: h[f], dataSeries: q, indexKeyword: 1, point: { x: l + (v - l) / 2, y: h[f].y[1] >= h[f].y[0] ? p : t }, direction: h[f].y[1] >= h[f].y[0] ? 1 : -1, bounds: { x1: l, y1: Math.min(p, t), x2: v, y2: Math.max(p, t) }, color: c })
                      }
                  } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation =
                    "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
            }
          }; l.prototype.renderError =
            function (a) {
              var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : d, c = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, p = this.plotArea, t = 0, g, k, m, n, q, h, r, l = a.axisX.dataInfo.minDiff; isFinite(l) || (l = 0.3 * Math.abs(a.axisX.range)); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(p.x1, p.y1, p.width, p.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(p.x1,
                        ...
                        c ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? v : 1))) << 0 : 0.03 * this.width); u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((c ? p.height : p.width) * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) / (z ? v : 1)) << 0; this.dataPointMaxWidth && e > t && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, t)); !this.dataPointMaxWidth && (this.dataPointMinWidth && t < e) && (t = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); u < e &&
                          (u = e); u > t && (u = t); if (0 < D.length) for (var F = C._colorSet, t = 0; t < D.length; t++) {
                            var e = C.lineColor = C.options.color ? C.options.color : F[0], Q = {
                              ...
                              var ja = a.axisX.convertValueToPixel(r); c ? k = ja : g = ja; ja = a.axisY.convertValueToPixel(D[t].y[0]); c ? m = ja : q = ja; ja = a.axisY.convertValueToPixel(D[t].y[1]); c ? n = ja : h = ja; c ? (q = a.axisX.reversed ? k + (z ?
                                v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : k - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, h = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? g + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : g - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, n = a.axisX.reversed ? m - u << 0 : m + u << 0); !c && q > h && (ja = q, q = h, h = ja); c && m > n && (ja = m, m = n, n = ja); ja = C.dataPointIds[t]; this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: t, x1: Math.min(m, n), y1: Math.min(q, h), x2: Math.max(n, m), y2: Math.max(h, q), isXYSwapped: c, stemProperties: aa, whiskerProperties: Q }; y(b, Math.min(m,
                                  n), Math.min(q, h), Math.max(n, m), Math.max(h, q), e, Q, aa, c); w && y(this._eventManager.ghostCtx, m, q, n, h, e, Q, aa, c); if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: D[t], dataSeries: C, indexKeyword: 0, point: { x: c ? D[t].y[1] >= D[t].y[0] ? m : n : m + (n - m) / 2, y: c ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? h : q }, direction: D[t].y[1] >= D[t].y[0] ? -1 : 1, bounds: { x1: c ? Math.min(m, n) : m, y1: c ? q : Math.min(q, h), x2: c ? Math.max(m, n) : n, y2: c ? h : Math.max(q, h) }, color: e, axisSwapped: c }),
                                    this._indexLabels.push({ chartType: "error", dataPoint: D[t], dataSeries: C, indexKeyword: 1, point: { x: c ? D[t].y[1] >= D[t].y[0] ? n : m : m + (n - m) / 2, y: c ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : h }, direction: D[t].y[1] >= D[t].y[0] ? 1 : -1, bounds: { x1: c ? Math.min(m, n) : m, y1: c ? q : Math.min(q, h), x2: c ? Math.max(m, n) : n, y2: c ? h : Math.max(q, h) }, color: e, axisSwapped: c })
                            }
                          }
                  } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height),
                    a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
              }
            }; l.prototype.renderRangeBar = function (a) {
              var d = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx :
                    ...
                    (e.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > p && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < f) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); m < f && (m = f); m > p && (m = p); b.save(); w && this._eventManager.ghostCtx.save(); b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); w && (this._eventManager.ghostCtx.beginPath(),
                      this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                        var q = a.dataSeriesIndexes[n], h = this.data[q], r = h.dataPoints; if (0 < r.length) {
                          var l = 5 < m && h.bevelEnabled ? !0 : !1; b.strokeStyle = "#4572A7 "; for (f = 0; f < r.length; f++)if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                            p = a.axisY.convertValueToPixel(r[f].y[0]);
                            t = a.axisY.convertValueToPixel(r[f].y[1]); g = a.axisX.convertValueToPixel(k); g = a.axisX.reversed ? g + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + n) * m << 0 : g - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + n) * m << 0; var v = a.axisX.reversed ? g - m << 0 : g + m << 0; p > t && (c = p, p = t, t = c); c = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length]; ca(b, p, g, t, v, c, 0, null, l, !1, !1, !1, h.fillOpacity); c = h.dataPointIds[f]; this._eventManager.objectMap[c] = {
                              id: c, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f,
                              x1: p, y1: g, x2: t, y2: v
                            }; c = P(c); w && ca(this._eventManager.ghostCtx, p, g, t, v, c, 0, null, !1, !1, !1, !1); if (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: r[f], dataSeries: h, indexKeyword: 0, point: { x: r[f].y[1] >= r[f].y[0] ? p : t, y: g + (v - g) / 2 }, direction: r[f].y[1] >= r[f].y[0] ? -1 : 1, bounds: { x1: Math.min(p, t), y1: g, x2: Math.max(p, t), y2: v }, color: c }), this._indexLabels.push({
                              chartType: "rangeBar", dataPoint: r[f], dataSeries: h, indexKeyword: 1, point: {
                                x: r[f].y[1] >=
                                  r[f].y[0] ? t : p, y: g + (v - g) / 2
                              }, direction: r[f].y[1] >= r[f].y[0] ? 1 : -1, bounds: { x1: Math.min(p, t), y1: g, x2: Math.max(p, t), y2: v }, color: c
                            })
                          }
                        }
                      } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1,
                        e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
                }
            }; l.prototype.renderRangeArea = function (a) {
              function d() {
                if (x) {
                  for (var a = null, b = g.length - 1; 0 <= b; b--)a = g[b], c.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2); c.closePath(); c.globalAlpha = m.fillOpacity; c.fill(); c.globalAlpha = 1; e.fill(); if (0 < m.lineThickness) {
                    c.beginPath(); c.moveTo(a.x, a.y2); for (b = 0; b < g.length; b++)a = g[b],
                      c.lineTo(a.x, a.y2); c.moveTo(g[0].x, g[0].y1); for (b = 0; b < g.length; b++)a = g[b], c.lineTo(a.x, a.y1); c.stroke()
                  } c.beginPath(); c.moveTo(r, l); e.beginPath(); e.moveTo(r, l); x = { x: r, y: l }; g = []; g.push({ x: r, y1: l, y2: s })
                }
              } var b = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], p = this.plotArea; c.save(); w && e.save(); c.beginPath(); c.rect(p.x1, p.y1, p.width, p.height); c.clip(); w && (e.beginPath(), e.rect(p.x1, p.y1, p.width, p.height), e.clip());
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                  var g = [], k = a.dataSeriesIndexes[t], m = this.data[k], n = m.dataPoints, f = m.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = P(f); e.fillStyle = f; var f = [], q = !0, h = 0, r, l, s, u, x = null; if (0 < n.length) {
                    var v = m._colorSet[h % m._colorSet.length], C = m.lineColor = m.options.lineColor || v, D = C; c.fillStyle = v; c.strokeStyle = C; c.lineWidth = m.lineThickness; var z = "solid"; if (c.setLineDash) {
                      var y = N(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, E = N(z,
                        m.lineThickness); c.setLineDash(E)
                      ...
                      r = a.axisX.convertValueToPixel(u); l = a.axisY.convertValueToPixel(n[h].y[0]); s = a.axisY.convertValueToPixel(n[h].y[1]); q || Q ? (m.connectNullData && !q ? (c.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType &&
                  ...
                  0, 0, this.width, this.height), c.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
              }
                ...
                var d = v(l, 2); if (0 < d.length) {
                  if (0 < k.lineThickness) {
                    c.strokeStyle = b; c.setLineDash && c.setLineDash(a); c.beginPath(); c.moveTo(d[0].x, d[0].y); for (var f = 0; f < d.length - 3; f += 3) {
                      if (d[f].newStrokeStyle || d[f].newLineDashArray) c.stroke(),
                        c.beginPath(), c.moveTo(d[f].x, d[f].y), d[f].newStrokeStyle && (c.strokeStyle = d[f].newStrokeStyle), d[f].newLineDashArray && c.setLineDash(d[f].newLineDashArray); c.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                    }
                  } c.beginPath(); c.moveTo(d[0].x, d[0].y); w && (e.beginPath(), e.moveTo(d[0].x, d[0].y)); for (f = 0; f < d.length - 3; f += 3)c.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), w && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y); d = v(s, 2); c.lineTo(s[s.length -
                    1].x, s[s.length - 1].y); for (f = d.length - 1; 2 < f; f -= 3)c.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), w && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); c.closePath(); c.globalAlpha = k.fillOpacity; c.fill(); w && (e.closePath(), e.fill()); c.globalAlpha = 1; if (0 < k.lineThickness) {
                      c.strokeStyle = b; c.setLineDash && c.setLineDash(a); c.beginPath(); c.moveTo(d[0].x, d[0].y); for (var h = f = 0; f < d.length - 3; f += 3, h++) {
                        if (l[h].newStrokeStyle || l[h].newLineDashArray) c.stroke(), c.beginPath(),
                          c.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (c.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && c.setLineDash(l[h].newLineDashArray); c.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                      } d = v(l, 2); c.moveTo(d[0].x, d[0].y); for (h = f = 0; f < d.length - 3; f += 3, h++) {
                        if (l[h].newStrokeStyle || l[h].newLineDashArray) c.stroke(), c.beginPath(), c.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (c.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && c.setLineDash(l[h].newLineDashArray); c.bezierCurveTo(d[f +
                          1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                      } c.stroke()
                    } c.beginPath()
                }
              } var b = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], p = this.plotArea; c.save(); w && e.save(); c.beginPath(); c.rect(p.x1, p.y1, p.width, p.height); c.clip(); w && (e.beginPath(), e.rect(p.x1, p.y1, p.width, p.height), e.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                      ...
                      var u = k._colorSet[n % k._colorSet.length], x = k.lineColor = k.options.lineColor || u, A = x; c.fillStyle = u; c.lineWidth = k.lineThickness; var C = "solid", D; if (c.setLineDash) { var z = N(k.nullDataLineDashType, k.lineThickness), C = k.lineDashType; D = N(C, k.lineThickness) } for (h = !1; n < m.length; n++)if (q = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                        !h))) if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                          q = a.axisX.convertValueToPixel(q); h = a.axisY.convertValueToPixel(m[n].y[0]); r = a.axisY.convertValueToPixel(m[n].y[1]); var y = k.dataPointIds[n]; this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: n, x1: q, y1: h, y2: r }; l[l.length] = { x: q, y: h }; s[s.length] = { x: q, y: r }; n < m.length - 1 && (A !== (m[n].lineColor || x) || C !== (m[n].lineDashType || k.lineDashType)) && (A = m[n].lineColor || x, l[l.length -
                            1].newStrokeStyle = A, c.setLineDash && (m[n].lineDashType ? (C = m[n].lineDashType, l[l.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, l[l.length - 1].newLineDashArray = D))); if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < k.markerSize)) {
                              var E = k.getMarkerProperties(n, q, h, c); f.push(E); var Q = P(y); w && f.push({ x: q, y: h, ctx: e, type: E.type, size: E.size, color: Q, borderColor: Q, borderThickness: E.borderThickness }); E = k.getMarkerProperties(n, q, r, c); f.push(E); Q = P(y); w && f.push({
                        ...
                        } else 0 < n && !h && (k.connectNullData ? c.setLineDash &&
                            ...
                            t = a.axisX.convertValueToPixel(m); g = 0 === s.dataPointEOs[p].cumulativeSum ? n : a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSum); k = 0 === s.dataPointEOs[p].cumulativeSumYStartValue ? n : a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSumYStartValue); t = a.axisX.reversed ? t + a.plotType.totalDataSeries *
                              q / 2 - (a.previousDataSeriesCount + h) * q << 0 : t - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + h) * q << 0; var E = a.axisX.reversed ? t - q << 0 : t + q << 0; g > k && (e = g, g = k, k = e); a.axisY.reversed && (e = g, g = k, k = e); e = s.dataPointIds[p]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: p, x1: t, y1: g, x2: E, y2: k }; var Q = v[p].color ? v[p].color : 0 < v[p].y ? s.risingColor : s.fallingColor; ca(b, t, g, E, k, Q, 0, Q, A, A, !1, !1, s.fillOpacity); e = P(e); w && ca(this._eventManager.ghostCtx, t, g, E, k, e, 0, null, !1,
                                !1, !1, !1); var aa, Q = t; aa = "undefined" !== typeof v[p].isIntermediateSum && !0 === v[p].isIntermediateSum || "undefined" !== typeof v[p].isCumulativeSum && !0 === v[p].isCumulativeSum ? 0 < v[p].y ? g : k : 0 < v[p].y ? k : g; 0 < p && D && (!C || s.connectNullData) && (C && b.setLineDash && b.setLineDash(N(y, u)), b.beginPath(), b.moveTo(D, z - x), b.lineTo(Q, aa - x), 0 < u && b.stroke(), w && (c.beginPath(), c.moveTo(D, z - x), c.lineTo(Q, aa - x), 0 < u && c.stroke())); C = !1; D = E; z = 0 < v[p].y ? g : k; Q = v[p].lineDashType ? v[p].lineDashType : s.options.lineDashType ? s.options.lineDashType :
                                  "shortDash"; b.strokeStyle = v[p].lineColor ? v[p].lineColor : s.options.lineColor ? s.options.lineColor : "#9e9e9e"; b.lineWidth = u; b.setLineDash && (Q = N(Q, u), b.setLineDash(Q)); (v[p].indexLabel || s.indexLabel || v[p].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: v[p], dataSeries: s, point: { x: t + (E - t) / 2, y: 0 <= v[p].y ? g : k }, direction: 0 > v[p].y === a.axisY.reversed ? 1 : -1, bounds: { x1: t, y1: Math.min(g, k), x2: E, y2: Math.max(g, k) }, color: e })
                        }
              ...
              function d() {
                if (k && m) {
                        ...
                        k._colorSet.length]; g.indexLabelLineThickness = s(f.indexLabelLineThickness) ? k.indexLabelLineThickness : f.indexLabelLineThickness; g.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : k.indexLabelLineDashType; g.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor : k.indexLabelFontColor; g.indexLabelFontStyle = f.indexLabelFontStyle ? f.indexLabelFontStyle : k.indexLabelFontStyle; g.indexLabelFontWeight = f.indexLabelFontWeight ? f.indexLabelFontWeight : k.indexLabelFontWeight; g.indexLabelFontSize =
                          s(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize; g.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : k.indexLabelFontFamily; g.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor; g.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * q.width; g.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ?
                            f.indexLabelWrap : k.indexLabelWrap; g.indexLabelTextAlign = f.indexLabelTextAlign ? f.indexLabelTextAlign : k.indexLabelTextAlign ? k.indexLabelTextAlign : "left"; g.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 * Math.PI : 0 : h[e - 1].endAngle; g.startAngle = (g.startAngle + 2 * Math.PI) % (2 * Math.PI); g.endAngle = g.startAngle + 2 * Math.PI / C * Math.abs(f.y); f = (g.endAngle + g.startAngle) / 2; f = (f + 2 * Math.PI) % (2 * Math.PI); g.midAngle = f; if (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) { if (0 === a || h[b].midAngle > g.midAngle) b = e; a++ } else if (g.midAngle >
                              3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) { if (0 === c || h[d].midAngle > g.midAngle) d = e; c++ } g.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; g.indexLabelTextBlock = new ia(l.plotArea.ctx, {
                  ...
                  } p = f = 0; n = !1; for (e = 0; e < m.length; e++)g = h[(b + e) % m.length], 1 < a && (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !n ? (g.hemisphere = "right", f++) : (g.hemisphere = "left", n = !0)); n = !1; for (e = 0; e < m.length; e++)g = h[(d + e) % m.length], 1 < c && (g.midAngle > 3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) && (p <= c / 2 && !n ? (g.hemisphere = "left", p++) : (g.hemisphere = "right", n = !0))
                }
              } function b(a) {
                var c = l.plotArea.ctx; c.clearRect(q.x1,
                  q.y1, q.width, q.height); c.fillStyle = l.backgroundColor; c.fillRect(q.x1, q.y1, q.width, q.height); for (c = 0; c < m.length; c++) {
                    var b = h[c].startAngle, d = h[c].endAngle; if (d > b) {
                      var e = 0.07 * z * Math.cos(h[c].midAngle), f = 0.07 * z * Math.sin(h[c].midAngle), p = !1; if (m[c].exploded) { if (1E-9 < Math.abs(h[c].center.x - (A.x + e)) || 1E-9 < Math.abs(h[c].center.y - (A.y + f))) h[c].center.x = A.x + e * a, h[c].center.y = A.y + f * a, p = !0 } else if (0 < Math.abs(h[c].center.x - A.x) || 0 < Math.abs(h[c].center.y - A.y)) h[c].center.x = A.x + e * (1 - a), h[c].center.y = A.y + f * (1 - a),
                        p = !0; p && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[c], e.index = c, l.toolTip.highlightObjects([e])); W(l.plotArea.ctx, h[c].center, h[c].radius, m[c].color ? m[c].color : k._colorSet[c % k._colorSet.length], k.type, b, d, k.fillOpacity, h[c].percentInnerRadius)
                    }
                  } a = l.plotArea.ctx; a.save(); a.fillStyle = "black"; a.strokeStyle = "grey"; a.textBaseline = "middle"; a.lineJoin = "round"; for (c = c = 0; c < m.length; c++)b = h[c], b.indexLabelText && (b.indexLabelTextBlock.y -= b.indexLabelTextBlock.height / 2, d = 0, d = "left" === b.hemisphere ? "inside" !==
                    k.indexLabelPlacement ? -(b.indexLabelTextBlock.width + n) : -b.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? n : -b.indexLabelTextBlock.width / 2, b.indexLabelTextBlock.x += d, b.indexLabelTextBlock.render(!0), b.indexLabelTextBlock.x -= d, b.indexLabelTextBlock.y += b.indexLabelTextBlock.height / 2, "inside" !== b.indexLabelPlacement && 0 < b.indexLabelLineThickness && (d = b.center.x + z * Math.cos(b.midAngle), e = b.center.y + z * Math.sin(b.midAngle), a.strokeStyle = b.indexLabelLineColor, a.lineWidth = b.indexLabelLineThickness,
                      a.setLineDash && a.setLineDash(N(b.indexLabelLineDashType, b.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(b.indexLabelTextBlock.x, b.indexLabelTextBlock.y), a.lineTo(b.indexLabelTextBlock.x + ("left" === b.hemisphere ? -n : n), b.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter"); a.save()
              } function c(a, c) {
                var b = 0, b = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2, d = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2, e = c.indexLabelTextBlock.y - c.indexLabelTextBlock.height / 2, f = c.indexLabelTextBlock.y +
                  c.indexLabelTextBlock.height / 2; return b = c.indexLabelTextBlock.y > a.indexLabelTextBlock.y ? e - d : b - f
              } function e(a) { for (var b = null, d = 1; d < m.length; d++)if (b = (a + d + h.length) % h.length, h[b].hemisphere !== h[a].hemisphere) { b = null; break } else if (h[b].indexLabelText && b !== a && (0 > c(h[b], h[a]) || ("right" === h[a].hemisphere ? h[b].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[b].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))) break; else b = null; return b } function f(a, b, d) {
                d = (d || 0) + 1; if (1E3 < d) return 0; b = b || 0; var k = 0,
                  p = A.y - 1 * w, g = A.y + 1 * w; if (0 <= a && a < m.length) {
                    var n = h[a]; if (0 > b && n.indexLabelTextBlock.y < p || 0 < b && n.indexLabelTextBlock.y > g) return 0; var q = 0, t = 0, t = q = q = 0; 0 > b ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > p && n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b < p && (b = -(p - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b))) : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < p && n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b > g && (b = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height /
                        ...
                        h[a].hemisphere && p !== a && (0 > c(h[p], h[a]) || ("right" === h[a].hemisphere ? h[p].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[p].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))) break; else p = null; t = p; q = e(a); g = p = 0; 0 > b ? (g = "right" === n.hemisphere ? t : q, k = b, null !== g && (t = -b, b = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (h[g].indexLabelTextBlock.y + h[g].indexLabelTextBlock.height / 2), b - t < r && (p = -t, g = f(g, p, d + 1), +g.toFixed(x) > +p.toFixed(x) && (k = b > r ? -(b - r) : -(t - (g - p)))))) : 0 < b && (g = "right" === n.hemisphere ?
                          q : t, k = b, null !== g && (t = b, b = h[g].indexLabelTextBlock.y - h[g].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2), b - t < r && (p = t, g = f(g, p, d + 1), +g.toFixed(x) < +p.toFixed(x) && (k = b > r ? b - r : t - (p - g))))); k && (d = n.indexLabelTextBlock.y + k, b = 0, b = "right" === n.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)), n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u ? (p = (a - 1 + h.length) % h.length, p = h[p], a = h[(a + 1 + h.length) % h.length], "left" === n.hemisphere &&
                            "right" === p.hemisphere && b > p.indexLabelTextBlock.x ? b = p.indexLabelTextBlock.x - 15 : "right" === n.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : n.midAngle > 3 * Math.PI / 2 - u && n.midAngle < 3 * Math.PI / 2 + u && (p = (a - 1 + h.length) % h.length, p = h[p], a = h[(a + 1 + h.length) % h.length], "right" === n.hemisphere && "left" === p.hemisphere && b < p.indexLabelTextBlock.x ? b = p.indexLabelTextBlock.x + 15 : "left" === n.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x -
                              15)), n.indexLabelTextBlock.y = d, n.indexLabelTextBlock.x = b, n.indexLabelAngle = Math.atan2(n.indexLabelTextBlock.y - A.y, n.indexLabelTextBlock.x - A.x))
                  } return k
              } function p() {
                var a = l.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline = "middle"; for (var b = a = 0, d = 0, p = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                  if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= y) p = !1; p && (z -= d); d = 0; if ("inside" !== k.indexLabelPlacement) {
                    w = z * v; for (a = 0; a < m.length; a++) {
                      ...
                      var g = h[a], s = e(a); if (null !== s) {
                        t = h[a]; u = h[s]; var C = 0, C = c(t, u) - r; if (0 > C) {
                    ...
                    n), s *= -1) : s = q.x1 - (g.indexLabelTextBlock.x - g.indexLabelTextBlock.width - n), 0 < s && (!p && g.indexLabelText && (u = "right" === g.hemisphere ? q.x2 - g.indexLabelTextBlock.x : g.indexLabelTextBlock.x - q.x1, 0.3 * g.indexLabelTextBlock.maxWidth > u ? g.indexLabelText = "" : g.indexLabelTextBlock.maxWidth = 0.85 * u, 0.3 * g.indexLabelTextBlock.maxWidth < u && (g.indexLabelTextBlock.x -= "right" === g.hemisphere ? 2 : -2)), Math.abs(g.indexLabelTextBlock.y - g.indexLabelTextBlock.height / 2 - A.y) < z || Math.abs(g.indexLabelTextBlock.y + g.indexLabelTextBlock.height /
                      2 - A.y) < z) && (s /= Math.abs(Math.cos(g.indexLabelAngle)), 9 < s && (s *= 0.3), s > d && (d = s)), s = s = 0, 0 < g.indexLabelAngle && g.indexLabelAngle < Math.PI ? (s = q.y2 - (g.indexLabelTextBlock.y + g.indexLabelTextBlock.height / 2 + 5), s *= -1) : s = q.y1 - (g.indexLabelTextBlock.y - g.indexLabelTextBlock.height / 2 - 5), 0 < s && (!p && g.indexLabelText && (u = 0 < g.indexLabelAngle && g.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, s * u) && f(a, 2 * u)), Math.abs(g.indexLabelTextBlock.x - A.x) < z && (s /= Math.abs(Math.sin(g.indexLabelAngle)), 9 < s && (s *= 0.3), s > d && (d = s))); var H = function (a,
                        c, b) { for (var d = [], e = 0; d.push(h[c]), c !== b; c = (c + 1 + m.length) % m.length); d.sort(function (a, c) { return a.y - c.y }); for (c = 0; c < d.length; c++)if (b = d[c], e < 0.7 * a) e += b.indexLabelTextBlock.height, b.indexLabelTextBlock.text = "", b.indexLabelText = "", b.indexLabelTextBlock.measureText(); else break }; (function () {
                          for (var a = -1, b = -1, d = 0, f = !1, k = 0; k < m.length; k++)if (f = !1, t = h[k], t.indexLabelText) {
                            var p = e(k); if (null !== p) {
                              var g = h[p]; C = 0; C = c(t, g); var q; if (q = 0 > C) {
                              ...
                              } q ? (0 > a && (a = k), p !== a && (b = p, d += -C), 0 === k % Math.max(m.length / 10, 3) && (f = !0)) : f = !0; f && (0 < d && 0 <= a && 0 <= b) && (H(d, a, b), b = a = -1, d = 0)
                            }
                          } 0 < d && H(d, a, b)
                        })()
                }
                  ...
                  this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, n = 10, q = this.plotArea, h = k.dataPointEOs, r = 2, w, v = 1.3, u = 20 / 180 * Math.PI, x = 6, A = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, C = 0; a = !1; for (var D = 0; D < m.length; D++)C += Math.abs(m[D].y), !a && ("undefined" !== typeof m[D].indexLabel && null !== m[D].indexLabel && 0 < m[D].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[D].label && null !== m[D].label && 0 < m[D].label.toString().length) && (a = !0); if (0 !== C) {
                    ...
                    var z = "inside" !== k.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2; k.radius && (z = Ra(k.radius, z)); var y = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ra(k.innerRadius, z) : 0.7 * z; k.radius = z; "doughnut" === k.type && (k.innerRadius = y); var E = Math.min(y / z, (z - 1) / z); this.pieDoughnutClickHandler = function (a) {
                      l.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0,
                        500, function (a) { b(a); g(); l.dispatchEvent("dataAnimationIterationEnd", { chart: l }); l.dispatchEvent("dataAnimationEnd", { chart: l }) }))
                    }; d(); p(); p(); p(); p(); this.disableToolTip = !0; this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                      var c = l.plotArea.ctx; c.clearRect(q.x1, q.y1, q.width, q.height); c.fillStyle = l.backgroundColor; c.fillRect(q.x1, q.y1, q.width, q.height); for (var c = h[0].startAngle + 2 * Math.PI * a, b = 0; b < m.length; b++) {
                        var d = 0 === b ? h[b].startAngle : e, e = d + (h[b].endAngle - h[b].startAngle),
                        f = !1; e > c && (e = c, f = !0); var p = m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length]; e > d && W(l.plotArea.ctx, h[b].center, h[b].radius, p, k.type, d, e, k.fillOpacity, h[b].percentInnerRadius); if (f) break
                      } g(); l.dispatchEvent("dataAnimationIterationEnd", { chart: l }); 1 <= a && l.dispatchEvent("dataAnimationEnd", { chart: l })
                    }, function () { l.disableToolTip = !1; l._animator.animate(0, l.animatedRender ? 500 : 0, function (a) { b(a); g(); l.dispatchEvent("dataAnimationIterationEnd", { chart: l }) }); l.dispatchEvent("dataAnimationEnd", { chart: l }) })
                  }
              }
            };
        var pa = function (a, d, b, c) { "undefined" === typeof b && (b = 1); 0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = b, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3), Math.round(d.y3)), a.lineTo(Math.round(d.x4), Math.round(d.y4)), "undefined" !== d.x5 && (a.lineTo(Math.round(d.x5), Math.round(d.y5)), a.lineTo(Math.round(d.x6), Math.round(d.y6))), a.closePath(), a.fillStyle = c ? c : d.color, a.fill(), a.globalAplha = 1, a.restore()) }; l.prototype.renderFunnel =
          function (a) {
            function d() { for (var a = 0, c = [], b = 0; b < x.length; b++) { if ("undefined" === typeof x[b].y) return -1; x[b].y = "number" === typeof x[b].y ? x[b].y : 0; a += Math.abs(x[b].y) } if (0 === a) return -1; for (b = c[0] = 0; b < x.length; b++)c.push(Math.abs(x[b].y) * E / a); return c } function b() {
              ...
              for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0; H < x.length; H++)if (!J && ("undefined" !== typeof x[H].indexLabel && null !== x[H].indexLabel && 0 < x[H].indexLabel.toString().length) && (J = !0), !J && ("undefined" !== typeof x[H].label && null !== x[H].label && 0 < x[H].label.toString().length) && (J = !0), !J && "function" === typeof u.indexLabelFormatter ||
                "function" === typeof x[H].indexLabelFormatter) J = !0; J = J || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length; "inside" !== u.indexLabelPlacement && J || (D = (A.width - 0.75 * F) / 2); var H = A.x1 + D, M = A.x2 - D, Y = A.y1 + C, P = A.y2 - C, R = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                  var ba, G; a = 75 * F / 100; var U = 30 * (M - a) / 100; "funnel" === u.type ? (ba = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight, G = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" ===
                    typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * E / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > E ? ba = E : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = ba = 0, u.reversed = u.reversed ? !1 : !0); var D = H + a / 2, X = H, Z = H + a, na = u.reversed ? P : Y, L = D - G / 2, V = D + G / 2, xa = u.reversed ? Y + ba : P - ba, sa = u.reversed ? Y : P; a = []; var D = [], O = [], F = [], T = Y, ca, $ = (xa - na) / (L - X), ea = -$, H = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? b() : d(); if (-1 !== H) {
          ...
          }(); l.prototype.cancelRequestAnimFrame = window.cancelAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout; l.prototype.set = function (a, d, b) { b = "undefined" === typeof b ? !0 : b; "options" === a ? (this.options = d, b && this.render()) : l.base.set.call(this, a, d, b) }; l.prototype.exportChart = function (a) {
            a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png", b = a.fileName ? a.fileName :
              this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + d); var c = this.canvas; if (c && d && b) {
                b = b + "." + d; a = "image/" + d; var c = c.toDataURL(a), e = !1, f = document.createElement("a"); f.download = b; f.href = c; if ("undefined" !== typeof Blob && new Blob) {
                  for (var p = c.replace(/^data:[a-z\/]*;base64,/, ""), p = atob(p), g = new ArrayBuffer(p.length), g = new Uint8Array(g), l = 0; l < p.length; l++)g[l] = p.charCodeAt(l); d = new Blob([g.buffer], { type: "image/" + d }); try { window.navigator.msSaveBlob(d, b), e = !0 } catch (k) {
            ...
            d.setAttribute("class", "canvasjs-chart-print-frame"); d.setAttribute("style", "position:absolute; width:100%; border: 0px; margin: 0px 0px 0px 0px; padding 0px 0px 0px 0px;"); d.style.height = this.height + "px"; this._canvasJSContainer.appendChild(d); var b = this, c = d.contentWindow || d.contentDocument.document || d.contentDocument; c.document.open(); c.document.write('<!DOCTYPE HTML>\n<html><body style="margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px;"><img src="' + a + '"/><body/></html>'); c.document.close(); setTimeout(function () {
              c.focus();
              c.print(); setTimeout(function () { b._canvasJSContainer.removeChild(d) }, 1E3)
            }, 500)
          }; l.prototype.getPercentAndTotal = function (a, d) {
            var b = null, c = null, e = b = null; if (0 <= a.type.indexOf("stacked")) c = 0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], b = a.plotUnit.yAbsTotals[b], e = isNaN(d.y) ? 0 : 0 === b ? 0 : 100 * (d.y / b)); else if ("pie" === a.type || "doughnut" === a.type || "funnel" === a.type || "pyramid" === a.type) {
            ...
            var f = this; e = "undefined" === typeof e ? 0 : e; if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type || "funnel" === b.type || "pyramid" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
              var p = "#percent", g = "#total", l = this.getPercentAndTotal(b, d), g = isNaN(l.total) ? g : l.total, p = isNaN(l.percent) ? p : l.percent; do {
                l = ""; if (b.percentFormatString) l = b.percentFormatString; else {
                  var l = "#,##0.",
                  k = Math.max(Math.ceil(Math.log(1 / Math.abs(p)) / Math.LN10), 2); if (isNaN(k) || !isFinite(k)) k = 2; for (var m = 0; m < k; m++)l += "#"; b.percentFormatString = l
                } a = a.replace("#percent", ea(p, l, f._cultureInfo)); a = a.replace("#total", ea(g, b.yValueFormatString ? b.yValueFormatString : "#,##0.########", f._cultureInfo))
              ...
              if ('"' === a[0] && '"' === a[a.length - 1] || "'" === a[0] && "'" === a[a.length - 1]) return a.slice(1, a.length - 1); a = Fa(a.slice(1,
                a.length - 1)); a = a.replace("#index", e); var k = null; try { var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/); h && 0 < h.length && (k = Fa(h[2]), a = Fa(h[1])) } catch (p) { } h = null; if ("color" === a) return "waterfall" === b.type ? d.color ? d.color : 0 < d.y ? b.risingColor : b.fallingColor : "error" === b.type ? b.color ? b.color : b._colorSet[k % b._colorSet.length] : d.color ? d.color : b.color ? b.color : b._colorSet[c % b._colorSet.length]; if (d.hasOwnProperty(a)) h = d; else if (b.hasOwnProperty(a)) h = b; else return ""; h = h[a]; null !== k && (h = h[k]); if ("x" === a) if (b.axisX && "dateTime" ===
                  b.axisX.valueType || "dateTime" === b.xValueType || d.x && d.x.getTime) { if (!b.axisX.logarithmic) return Aa(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo) } else return ea(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" === a ? ea(h, d.yValueFormatString ?
                    d.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ea(h, d.zValueFormatString ? d.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", f._cultureInfo) : h
            })
          }; oa(F, U); F.prototype.setLayout = function () {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = null, c = 0, e = 0, f = 0, p = 0, g = this.markerMargin = this.chart.options.legend && !s(this.chart.options.legend.markerMargin) ?
              this.chart.options.legend.markerMargin : 0.3 * this.fontSize; this.height = 0; var l = [], k = []; if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", b = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height; else if ("center" === this.verticalAlign) {
                this.orientation = "vertical"; if ("left" === this.horizontalAlign || "center" === this.horizontalAlign || "right" === this.horizontalAlign) b = this.horizontalAlign;
                ...
                d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, c = d.y2 - this.height); this.items = l; for (m = 0; m < this.items.length; m++)q = l[m], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex }; this.markerSize = w; this.rows = k; 0 < l.length && a.layoutManager.registerSpace(b, { width: this.width + 2 + 2, height: this.height + 5 + 5 }); this.bounds = {
                  x1: e, y1: c, x2: e +
                      ...
                      switch (this.type) {
                        case "column": case "stackedColumn": case "stackedColumn100": case "bar": case "stackedBar": case "stackedBar100": case "rangeColumn": case "rangeBar": case "waterfall": case "error": a >=
                          q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (c.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), g = !0); break; case "line": case "stepLine": case "spline": case "area": case "stepArea": case "stackedArea": case "stackedArea100": case "splineArea": case "scatter": var s = la("markerSize", h, this) || 4, w = b ? 20 : s, r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); r <= w && c.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: r }); q =
                            Math.abs(q.x1 - a); q <= l ? l = q : 0 < p ? k++ : m++; r <= s / 2 && (g = !0); break; case "rangeArea": case "rangeSplineArea": s = la("markerSize", h, this) || 4; w = b ? 20 : s; r = Math.min(Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)), Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y2 - d, 2))); r <= w && c.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: r }); q = Math.abs(q.x1 - a); q <= l ? l = q : 0 < p ? k++ : m++; r <= s / 2 && (g = !0); break; case "bubble": s = q.size; r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); r <= s / 2 && (c.push({
                              dataPoint: h, dataPointIndex: f, dataSeries: this,
                              distance: r
                            }), g = !0); break; case "pie": case "doughnut": s = q.center; w = "doughnut" === this.type ? q.percentInnerRadius * q.radius : 0; r = Math.sqrt(Math.pow(s.x - a, 2) + Math.pow(s.y - d, 2)); r < q.radius && r > w && (r = Math.atan2(d - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), s >= w && 0 !== h.y && (w += 360, r < s && (r += 360)), r > s && r < w && (c.push({
                              dataPoint: h,
            ...
            a = (a || 0) + 1; if (!(5 < a)) {
              var d = this.logLabelValues[0] || this.intervalStartPosition; if (Math.log(this.range) / Math.log(d / this.viewportMinimum) <
                this.noTicks - 1) { for (var b = E.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), c = Math.ceil(this.viewportMinimum / b) * b; c < d; c += b)c < this.viewportMinimum || this.logLabelValues.push(c); this.logLabelValues.sort(Pa); this.createExtraLabelsForLog(a) }
            }
            ...
            var a, d, b = 0, c = 0, e, f = 0, p = 0, c = 0, c = this.interval, g = 0, l, k = 0.6 * this.chart.height, m; a = !1; var n = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], q = n.length ? s(this.scaleBreaks.firstBreakIndex) ?
              0 : this.scaleBreaks.firstBreakIndex : 0; if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                } h = q; for (b = this.intervalStartPosition; b <= e; b = parseFloat(1E-12 > this.interval ? this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase,
                ...
                this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Va(new Date(this.viewportMaximum), this.interval, this.intervalType), h = q, b = this.intervalStartPosition; b < e; Va(b, c, this.intervalType)) {
                  for (a = b.getTime(); h < n.length && a > n[h].endValue; h++); m = a; a = h < n.length && a >= n[h].startValue && a <= n[h].endValue; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(m), label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ?
                ...
                Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * R[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (f = "undefined" === typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), p = "undefined" ===
                  typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize; for (c = 0; c < this._labels.length; c++) { a = this._labels[c].textBlock; a.maxWidth = f; a.maxHeight = p; var r = a.measureText(); l = r.height } e = []; q = n = 0; if (this.labelAutoFit || this.options.labelAutoFit) if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position ||
                    "top" === this._position) if (f = 0.9 * g >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                      this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = f; this.sessionVariables.labelMaxHeight = p; this.sessionVariables.labelAngle = this.labelAngle; this.sessionVariables.labelWrap = this.labelWrap; for (b = 0; b < this._labels.length; b++)if (!this._labels[b].breaksLabelType) {
                        a = this._labels[b].textBlock; for (var v, h = a.text.split(" "), c = 0; c < h.length; c++)m = h[c], this.ctx.font = a.fontStyle + " " +
                          a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, m = this.ctx.measureText(m), m.width > q && (v = b, q = m.width)
                      } b = 0; for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (!this._labels[b].breaksLabelType) {
                        a = this._labels[b].textBlock; r = a.measureText(); for (h = b + 1; h < this._labels.length; h++)if (!this._labels[h].breaksLabelType) { d = this._labels[h].textBlock; d = d.measureText(); break } e.push(a.height); this.sessionVariables.labelMaxHeight = Math.max.apply(Math, e); Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                        ...
                        } else (this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((c - f * Math.cos(Math.PI /
                      ...
                      a.measureText(); else if ("left" === this._position || "right" === this._position) if (f = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, p = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = s(this.options.labelAngle) ? s(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = s(this.options.labelWrap) ? s(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = s(this.sessionVariables.labelMaxHeight) ?
                          this.sessionVariables.labelMaxHeight = p : this.sessionVariables.labelMaxHeight, a.measureText(); for (b = 0; b < this.stripLines.length; b++) {
                            var f = this.stripLines[b], y; if ("outside" === f.labelPlacement) {
            ...
            var a = 0, d = 0; this._labels = []; this._stripLineLabels = []; var b = this.chart.isNavigator ? 0 : 5; if ("left" === this._position || "right" === this._position) {
              this.createLabels(); if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index) for (d =
                0; d < this._labels.length; d++) { var c = this._labels[d].textBlock, e = c.measureText(), f = 0, f = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - c.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)); a < f && (a = f); this._labels[d].effectiveWidth = f } for (d = 0; d < this._stripLineLabels.length; d++)"outside" === this._stripLineLabels[d].stripLine.labelPlacement && (this._stripLineLabels[d].stripLine.value >= this.viewportMinimum && this._stripLineLabels[d].stripLine.value <= this.viewportMaximum) &&
                  (c = this._stripLineLabels[d].textBlock, e = c.measureText(), f = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - c.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), a < f && (a = f), this._stripLineLabels[d].effectiveWidth = f)
            ...
            var a = 0; this._labels = []; this._stripLineLabels = []; var d, b = 0,
              c = this.chart.isNavigator ? 0 : 5; if ("bottom" === this._position || "top" === this._position) {
                this.createLabels(); if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index) for (b = 0; b < this._labels.length; b++) { d = this._labels[b].textBlock; var e = d.measureText(), f = 0, f = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)); a < f && (a = f); this._labels[b].effectiveHeight = f } for (b = 0; b < this._stripLineLabels.length; b++)"outside" ===
            ...
            var p, g, l, k, m = a[0] ? a[0].chart : d[0].chart, n = m.isNavigator ? 0 : 10, q = m._axes; if (a && 0 < a.length) for (var h = 0; h < a.length; h++)a[h] && a[h].calculateAxisParameters(); if (d && 0 < d.length) for (h = 0; h < d.length; h++)d[h].calculateAxisParameters(); if (b && 0 < b.length) for (h = 0; h < b.length; h++)b[h].calculateAxisParameters(); if (c && 0 < c.length) for (h = 0; h < c.length; h++)c[h].calculateAxisParameters(); for (h = 0; h < q.length; h++)if (q[h] && q[h].scaleBreaks &&
                    ...
                    m.sessionVariables.axisY.height = n[h] : m.sessionVariables.axisY.height; else for (h = 0; h < b.length; h++)m.sessionVariables.axisY.height = n[h]; if (b && 0 < b.length) for (h = b.length - 1; 0 <= h; h--)g = Math.round(f.y2), k = Math.round(f.y2 > b[h].chart.height ? b[h].chart.height : f.y2), b[h].lineCoordinates.y1 = g - (n[h] + b[h].margin + V), b[h].lineCoordinates.y2 = g - (n[h] + b[h].margin + V), "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.y1 = b[h].lineCoordinates.y1 + n[h] - (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0) - ("inside" ===
                      b[h].tickPlacement ? b[h].tickLength : 0), b[h].lineCoordinates.y2 = b[h].lineCoordinates.y1 + b[h].lineThickness / 2), b[h].bounds = { x1: p, y1: g - (n[h] + V + b[h].margin), x2: l, y2: k - (V + b[h].margin), width: l - p, height: n[h] }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width), V += n[h] + b[h].margin; if (c && 0 < c.length) for (h = c.length - 1; 0 <= h; h--)c[h] && (g = Math.round(f.y1), k = Math.round(f.y1 + (z[h] + c[h].margin + G)), c[h].lineCoordinates.y1 =
                        k, c[h].lineCoordinates.y2 = k, "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.y1 = k - z[h] + (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)), c[h].bounds = { x1: p, y1: g + (c[h].margin + G), x2: l, y2: k, width: l - p, height: S }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width), G += z[h] + c[h].margin); if (a && 0 < a.length) for (h = 0; h < a.length; h++) {
                          ...
                          L = d[h]._labels && 0 < d[h]._labels.length ? d[h]._labels[0].textBlock.fontSize / 2 : 0; p = Math.round(f.x1 - e); g = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y2 : f.y1 <
                          ...
                          if (a && 0 < a.length) for (h = 0; h < a.length; h++)r = M[w - 1][h] === M[w][h] ? !0 : !1; else r = !0; if (d && 0 < d.length) for (h = 0; h < d.length; h++)H = N[w - 1][h] === N[w][h] ? !0 :
                            !1; else H = !0; if (b && 0 < b.length) for (h = 0; h < b.length; h++)J = E[w - 1][h] === E[w][h] ? !0 : !1; else J = !0; if (c && 0 < c.length) for (h = 0; h < c.length; h++)K = u[w - 1][h] === u[w][h] ? !0 : !1; else K = !0
                        } if (r && H && J && K) break; w++
                } if (b && 0 < b.length) for (h = 0; h < b.length; h++)b[h].calculateStripLinesThicknessInValues(), b[h].calculateBreaksInPixels(); if (c && 0 < c.length) for (h = 0; h < c.length; h++)c[h].calculateStripLinesThicknessInValues(), c[h].calculateBreaksInPixels(); if (a && 0 < a.length) for (h = 0; h < a.length; h++)a[h].calculateStripLinesThicknessInValues(),
            ...
            function () {
              ...
              var a = this, d = !1, b = 0, c = 0, e = 1, f = 0; 0 !== this.labelAngle && 360 !== this.labelAngle && (e = 1.2); if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                  for (var b = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, l = this.viewportMaximum, s = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length -
                  ...
                  for (k = 0; k < this._labels.length; k++)n = this._labels[k], n.position < this.viewportMinimum || (g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height *
                    Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += g); b > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0)
                  ...
                  for (var b = [], m, l = this.viewportMaximum, s = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                    n = this._labels[k]; if (n.position < this.viewportMinimum) break; n.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(l / n.position) *
                      s) || (b.push(n), l = n.position, m = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                  } this._labels = b
                } else { for (k = 0; k < this._labels.length; k++)n = this._labels[k], n.position < this.viewportMinimum || (m = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += m); c > this.lineCoordinates.height * e && this.labelAutoFit && (d = !0) }
              ...
              function () {
                ...
                if (this.stripLines &&
                  0 < this.stripLines.length && a) {
                    for (var d = this, b, c = 0, e = 0, f = !1, g = !1, l = [], w = [], g = !1, c = 0; c < this.stripLines.length; c++) { var k = this.stripLines[c]; k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || s(k.value) || isNaN(this.range)) || "value" === a && (k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum || k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum || s(k.startValue) || s(k.endValue) || isNaN(this.range)) || l.push(k)) } for (c = 0; c < this._stripLineLabels.length; c++)if (k =
                      this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                        a = this.getPixelCoordinatesOnAxis(b.position); if ("outside" === b.stripLine.labelPlacement) if (k && (this.ctx.strokeStyle = k.color, "pixel" === k._thicknessType && (this.ctx.lineWidth = k.thickness)), "bottom" === this._position) {
                        ...
                        } else "top" === this._position ? (m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(m, a.y << 0), this.ctx.lineTo(m, a.y - this.tickLength << 0), this.ctx.stroke(), 0 === this.labelAngle ? (a.x -= b.textBlock.width /
                                ...
                                this.chart.plotArea.y1 + b.textBlock.width) / 2 : this.chart.plotArea.y2 - 3 : "near" === b.stripLine.labelAlign ? this.chart.plotArea.y1 + 3 : "center" === b.stripLine.labelAlign ? (this.chart.plotArea.y2 + this.chart.plotArea.y1 - b.textBlock.width) / 2 : this.chart.plotArea.y2 - b.textBlock.width - 3) : "left" === this._position ? (b.textBlock.maxWidth = this.options.stripLines[c].labelMaxWidth ? this.options.stripLines[c].labelMaxWidth : this.chart.plotArea.width - 3, b.textBlock.angle = 0, b.textBlock.measureText(), a.y - b.textBlock.height > this.chart.plotArea.y1 ?
                                  s(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize + 3 : a.y - b.textBlock.height < this.chart.plotArea.y2 ? a.y += b.textBlock.fontSize / 2 + 3 : s(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize + 3, a.x = "near" === b.stripLine.labelAlign ? this.chart.plotArea.x1 + 3 : "center" === b.stripLine.labelAlign ? (this.chart.plotArea.x2 + this.chart.plotArea.x1) / 2 - b.textBlock.width / 2 : this.chart.plotArea.x2 - b.textBlock.width -
                                    3) : "right" === this._position && (b.textBlock.maxWidth = this.options.stripLines[c].labelMaxWidth ? this.options.stripLines[c].labelMaxWidth : this.chart.plotArea.width - 3, b.textBlock.angle = 0, b.textBlock.measureText(), a.y - +b.textBlock.height > this.chart.plotArea.y1 ? s(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 - 3 : a.y - b.textBlock.height < this.chart.plotArea.y2 ? a.y += b.textBlock.fontSize / 2 + 3 : s(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize /
                                      2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3, a.x = "near" === b.stripLine.labelAlign ? this.chart.plotArea.x2 - b.textBlock.width - 3 : "center" === b.stripLine.labelAlign ? (this.chart.plotArea.x2 + this.chart.plotArea.x1) / 2 - b.textBlock.width / 2 : this.chart.plotArea.x1 + 3); b.textBlock.x = a.x; b.textBlock.y = a.y; w.push(b)
                    } if (!g) {
                      g = !1; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (c = 0; c < l.length; c++)k =
                        l[c], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () { this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (e = 0; e < l.length; e++)k = l[e], k.showOnTop && k.render(); this.ctx.restore() }, k)) : k.render(); for (c = 0; c < w.length; c++)b = w[c], b.stripLine.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                          for (e = 0; e < w.length; e++)b =
                            w[e], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), b.textBlock.render(!0), d.ctx.restore())
                        }, b.textBlock)) : "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0); this.ctx.restore(); g = !0
                ...
                var a = this.chart.ctx, d = w ? this.chart._preRenderCtx : a, b = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), c = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f; d.save(); if ("bottom" === this._position || "top" === this._position) {
                  if (this.lineThickness) {
                    ...
                    d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor ? this.lineColor : "black"; d.setLineDash && d.setLineDash(N(this.lineDashType, this.lineThickness)); var g = 1 === this.lineThickness % 2 ? (this.lineCoordinates.y1 << 0) + 0.5 : this.lineCoordinates.y1 << 0; d.beginPath(); if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c; else for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)d.moveTo(e,
                      g), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + b, g), e = this.scaleBreaks._appliedBreaks[l].endPixel + c; e && (d.moveTo(e, g), d.lineTo(f, g)); d.stroke()
                  }
                ...
                if ("undefined" === typeof a) return null; var d = 0, b = 0, c, d = !0, e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], b = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x; if (this.logarithmic) {
                  a = c = Math.pow(this.logarithmBase, (b - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit); if (b <= this.conversionParameters.reference === ("left" === this._position ||
                    "right" === this._position) !== this.reversed) for (b = 0; b < e.length; b++) {
                      if (!(e[b].endValue < this.conversionParameters.minimum)) if (d) if (e[b].startValue < this.conversionParameters.minimum) {
                        if (1 < e[b].size && this.conversionParameters.minimum * Math.pow(e[b].endValue / e[b].startValue, Math.log(c) / Math.log(e[b].size)) < e[b].endValue) { a = Math.pow(e[b].endValue / e[b].startValue, Math.log(c) / Math.log(e[b].size)); break } else a *= e[b].endValue / this.conversionParameters.minimum / Math.pow(e[b].size, Math.log(e[b].endValue / this.conversionParameters.minimum) /
                          Math.log(e[b].endValue / e[b].startValue)), c /= Math.pow(e[b].size, Math.log(e[b].endValue / this.conversionParameters.minimum) / Math.log(e[b].endValue / e[b].startValue)); d = !1
                      } else if (c > e[b].startValue / this.conversionParameters.minimum) { c /= e[b].startValue / this.conversionParameters.minimum; if (c < e[b].size) { a *= Math.pow(e[b].endValue / e[b].startValue, 1 === e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) / c; break } else a *= e[b].endValue / e[b].startValue / e[b].size; c /= e[b].size; d = !1 } else break; else if (c > e[b].startValue / e[b -
                        1].endValue) { c /= e[b].startValue / e[b - 1].endValue; if (c < e[b].size) { a *= Math.pow(e[b].endValue / e[b].startValue, 1 === e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) / c; break } else a *= e[b].endValue / e[b].startValue / e[b].size; c /= e[b].size } else break
                      ...
                      if (1 < e[b].size && this.conversionParameters.minimum * Math.pow(e[b].endValue / e[b].startValue, Math.log(c) / Math.log(e[b].size)) >
                      ...
                      if (c > 1 / e[b].size) { a *= Math.pow(e[b].endValue / e[b].startValue, 1 >= e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) * c; break } else a /= e[b].endValue / e[b].startValue / e[b].size; c *= e[b].size; d = !1
                    } else break; else if (c < e[b].endValue / e[b + 1].startValue) { c /= e[b].endValue / e[b + 1].startValue; if (c > 1 / e[b].size) { a *= Math.pow(e[b].endValue / e[b].startValue, 1 >= e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) * c; break } else a /= e[b].endValue / e[b].startValue / e[b].size; c *= e[b].size } else break; d = a * this.viewportMinimum
                } else {
                  a = c = (b - this.conversionParameters.reference) /
                  this.conversionParameters.pixelPerUnit; if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (b = 0; b < e.length; b++) {
                    if (!(e[b].endValue < this.conversionParameters.minimum)) if (d) if (e[b].startValue < this.conversionParameters.minimum) {
                      if (e[b].size && this.conversionParameters.minimum + c * (e[b].endValue - e[b].startValue) / e[b].size < e[b].endValue) { a = 0 >= e[b].size ? 0 : c * (e[b].endValue - e[b].startValue) / e[b].size; break } else a += e[b].endValue - this.conversionParameters.minimum -
                        e[b].size * (e[b].endValue - this.conversionParameters.minimum) / (e[b].endValue - e[b].startValue), c -= e[b].size * (e[b].endValue - this.conversionParameters.minimum) / (e[b].endValue - e[b].startValue); d = !1
                    } else if (c > e[b].startValue - this.conversionParameters.minimum) { c -= e[b].startValue - this.conversionParameters.minimum; if (c < e[b].size) { a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) - c; break } else a += e[b].endValue - e[b].startValue - e[b].size; c -= e[b].size; d = !1 } else break; else if (c > e[b].startValue - e[b -
                      1].endValue) { c -= e[b].startValue - e[b - 1].endValue; if (c < e[b].size) { a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) - c; break } else a += e[b].endValue - e[b].startValue - e[b].size; c -= e[b].size } else break
                  } else for (b = e.length - 1; 0 <= b; b--)if (!(e[b].startValue > this.conversionParameters.minimum)) if (d) if (e[b].endValue > this.conversionParameters.minimum) if (e[b].size && this.conversionParameters.minimum + c * (e[b].endValue - e[b].startValue) / e[b].size > e[b].startValue) {
                    a = 0 >= e[b].size ? 0 : c * (e[b].endValue - e[b].startValue) /
                      e[b].size; break
                    ...
                    c -= e[b].endValue - this.conversionParameters.minimum; if (c > -1 * e[b].size) { a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c; break } else a -= e[b].endValue - e[b].startValue -
                ...
                if (this.logarithmic) {
                  b = s(b) ? d / a : b; for (var f = 0; f < e.length && !(d < e[f].startValue); f++)a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? b = b / e[f].endValue * e[f].startValue * e[f].size : a >= e[f].startValue && d >= e[f].endValue ? b = b / e[f].endValue * a * Math.pow(e[f].size, Math.log(e[f].endValue / a) / Math.log(e[f].endValue / e[f].startValue)) : a <= e[f].startValue && d <= e[f].endValue ? b = b / d * e[f].startValue * Math.pow(e[f].size, Math.log(d / e[f].startValue) / Math.log(e[f].endValue / e[f].startValue)) : !c && (a > e[f].startValue && d < e[f].endValue) &&
                    (b = a * Math.pow(e[f].size, Math.log(d / a) / Math.log(e[f].endValue / e[f].startValue))))
                } else for (b = s(b) ? Math.abs(d - a) : b, f = 0; f < e.length && !(d < e[f].startValue); f++)a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? b = b - e[f].endValue + e[f].startValue + e[f].size : a > e[f].startValue && d >= e[f].endValue ? b = b - e[f].endValue + a + e[f].size * (e[f].endValue - a) / (e[f].endValue - e[f].startValue) : a <= e[f].startValue && d < e[f].endValue ? b = b - d + e[f].startValue + e[f].size * (d - e[f].startValue) / (e[f].endValue - e[f].startValue) : !c && (a > e[f].startValue &&
                  d < e[f].endValue) && (b = a + e[f].size * (d - a) / (e[f].endValue - e[f].startValue))); return b
                ...
                function (a) {
                        ...
                        a[e].startValue); e++)this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? b = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c - a[e].endValue + a[e].startValue, b = 0 < a[e].spacing.toString().indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100) : b - Math.min(a[e].spacing, 0.1 * b)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c - a[e].endValue + this.viewportMinimum, b = 0 < a[e].spacing.toString().indexOf("%") ?
                          b * (1 - parseFloat(a[e].spacing) / 100 * (a[e].endValue - this.viewportMinimum) / (a[e].endValue - a[e].startValue)) : b - Math.min(a[e].spacing, 0.1 * b) * (a[e].endValue - this.viewportMinimum) / (a[e].endValue - a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (c = c - this.viewportMaximum + a[e].startValue, b = 0 < a[e].spacing.toString().indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)) : b - Math.min(a[e].spacing, 0.1 * b) * (this.viewportMaximum -
                            a[e].startValue) / (a[e].endValue - a[e].startValue))); d.minimum = this.viewportMinimum; d.maximum = this.viewportMaximum; d.range = c; if ("bottom" === this._position || "top" === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? -1 : 1) * b * d.lnLogarithmBase / Math.log(Math.abs(c))) : d.pixelPerUnit = (this.reversed ? -1 : 1) * b / Math.abs(c), d.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1; if ("left" === this._position || "right" === this._position) this.logarithmic ?
                              (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? 1 : -1) * b * d.lnLogarithmBase / Math.log(Math.abs(c))) : d.pixelPerUnit = (this.reversed ? 1 : -1) * b / Math.abs(c), d.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2; this.conversionParameters = d
                }; E.prototype.calculateAxisParameters = function () {
                  if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                    var a = this.chart.layoutManager.getFreeSpace(), d = !1, b = !1; "bottom" === this._position || "top" === this._position ? (this.maxWidth =
                    ...
                    if (s(this.options.viewportMinimum) && !s(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum; if (s(this.options.viewportMaximum) && !s(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) this.viewportMaximum = this.sessionVariables.newViewportMaximum; else if (null === this.viewportMaximum ||
                      isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum; if (this.scaleBreaks) for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++)if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) && (!s(this.sessionVariables.newViewportMaximum) &&
                        this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue || !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[c].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue)) { this.scaleBreaks._appliedBreaks.splice(c, 1); break } if ("axisX" === this.type) {
                          if (this.dataSeries && 0 < this.dataSeries.length) for (e = 0; e < this.dataSeries.length; e++)"dateTime" === this.dataSeries[e].xValueType && (b = !0); e = null !== this.viewportMinimum ?
                            this.viewportMinimum : this.dataInfo.viewPortMin; f = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax; 0 === f - e && (c = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, f += c, e -= c); Infinity !== this.dataInfo.minDiff ? g = this.dataInfo.minDiff : 1 < f - e ? g = 0.5 * Math.abs(f - e) : (g = 1, b && (d = !0))
                          ...
                          isFinite(f) ? isFinite(e) ? isFinite(f) || (f = e) : e = f : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (c = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += c, e -= c) : e > f ? (c = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - c : f = isFinite(e) ? e + c : 0) : (c = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += c), 0 !== e && (e -=
                            c)), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < e && (e = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > f && (f = 0)); c = this.getApparentDifference(isNaN(this.viewportMinimum) || null === this.viewportMinimum ? e : this.viewportMinimum, isNaN(this.viewportMaximum) || null === this.viewportMaximum ? f : this.viewportMaximum, null, !0); if ("axisX" === this.type && b) {
                              this.intervalType ||
                      ...
                      this.maximum : this.dataInfo.max, 0 === f - e && (c = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, f += c, e -= c), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(e) || isFinite(f) ? 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (c = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += c, e -= c) : e > f ? (c = Math.min(0.01 * Math.abs(this.getApparentDifference(f,
                        e, null, !0)), 5), 0 <= f ? e = f - c : f = isFinite(e) ? e + c : 0) : (c = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += c), 0 !== e && (e -= c)) : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < e && (e = 0), this.includeZero && (null === this.maximum ||
                          isNaN(this.maximum)) && 0 > f && (f = 0)), Math.abs(this.getApparentDifference(e, f, null, !0)), "axisX" === this.type && b) {
                                            ...
                                            0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum))), 1 === this.maximum && 1 === this.minimum && (1 === this.options.minimum ? this.maximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this.options.maximum && (this.minimum /= this.logarithmBase - 1 / this.logarithmBase)); this.viewportMinimum = Math.max(this.viewportMinimum, this.minimum); this.viewportMaximum = Math.min(this.viewportMaximum, this.maximum); this.viewportMinimum > this.viewportMaximum && (!this.options.viewportMinimum && !this.options.minimum ||
                                              this.options.viewportMaximum || this.options.maximum ? this.options.viewportMinimum || this.options.minimum || !this.options.viewportMaximum && !this.options.maximum || (this.viewportMinimum = this.minimum = (this.options.viewportMaximum || this.options.maximum) / Math.pow(this.logarithmBase, 2 * Math.ceil(this.interval))) : this.viewportMaximum = this.maximum = this.options.viewportMinimum || this.options.minimum); c = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval); this.range =
                                                this.viewportMaximum / this.viewportMinimum; this.noTicks = a; if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) { for (d = Math.floor(this.viewportMinimum / b + 0.5) * b; d < this.viewportMinimum;)d += b; this.equidistantInterval = !1; this.intervalStartPosition = d; this.interval = b } else this.options.interval || (b = Math.ceil(this.interval), this.range > this.interval && (this.interval = b, c = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))),
                                                  this.equidistantInterval = !0, this.intervalStartPosition = c; if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { d = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2; if (isNaN(d) || !isFinite(d)) d = 2; if (2 < d) for (g = 0; g < d - 2; g++)this.valueFormatString += "#" }
                }; E.generateValueFormatString = function (a, d) { var b = "#,##0.", c = d; 1 > a && (c += Math.floor(Math.abs(Math.log(a) / Math.LN10)), isNaN(c) || !isFinite(c)) && (c = d); for (var e = 0; e < c; e++)b += "#"; return b }; E.getNiceExponent = function (a,
                  d) { var b = Math.floor(Math.log(a) / Math.LN10), c = a / Math.pow(10, b), c = 0 > b ? 1 >= c ? 1 : 5 >= c ? 5 : 10 : Math.max(Math.floor(c), 1); return -20 > b ? Number(c * Math.pow(10, b)) : Number((c * Math.pow(10, b)).toFixed(20)) }; E.getNiceNumber = function (a, d) { var b = Math.floor(Math.log(a) / Math.LN10), c = a / Math.pow(10, b), c = d ? 1.5 > c ? 1 : 3 > c ? 2 : 7 > c ? 5 : 10 : 1 >= c ? 1 : 2 >= c ? 2 : 5 >= c ? 5 : 10; return -20 > b ? Number(c * Math.pow(10, b)) : Number((c * Math.pow(10, b)).toFixed(20)) }; E.prototype.getLabelStartPoint = function () {
                        ...
                        this.ctx, b = this.ctx.globalAlpha; this.ctx = a || this.ctx; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); var c = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue), e = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue); this.ctx.strokeStyle = this.lineColor; this.ctx.fillStyle = this.color; this.ctx.beginPath(); this.ctx.globalAlpha = 1; P(this.id); var f, g, l, s, k, m; a = Math.max(this.spacing,
                          3); var n = Math.max(0, this.lineThickness); this.ctx.lineWidth = n; this.ctx.setLineDash && this.ctx.setLineDash(N(this.lineDashType, n)); if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (c = 1 === n % 2 ? (c.x << 0) + 0.5 : c.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c - n / 2, y1: e, x2: g + n / 2, y2: l }, this.ctx.moveTo(c,
                            e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(c, l), this.ctx.lineTo(g, l), this.ctx.lineTo(g, e); else if ("wavy" === this.type) { s = c; k = e; f = 0.5; m = (l - k) / a / 3; for (var q = 0; q < m; q++)this.ctx.bezierCurveTo(s + f * a, k + a, s + f * a, k + 2 * a, s, k + 3 * a), k += 3 * a, f *= -1; this.ctx.bezierCurveTo(s + f * a, k + a, s + f * a, k + 2 * a, s, k + 3 * a); s = g; f *= -1; this.ctx.lineTo(s, k); for (q = 0; q < m; q++)this.ctx.bezierCurveTo(s + f * a, k - a, s + f * a, k - 2 * a, s, k - 3 * a), k -= 3 * a, f *= -1 } else {
                              if ("zigzag" ===
                                this.type) { f = -1; k = e + a; s = c + a; m = (l - k) / a / 2; for (q = 0; q < m; q++)this.ctx.lineTo(s, k), s += 2 * f * a, k += 2 * a, f *= -1; this.ctx.lineTo(s, k); s += g - c; for (q = 0; q < m + 1; q++)this.ctx.lineTo(s, k), s += 2 * f * a, k -= 2 * a, f *= -1; this.ctx.lineTo(s + f * a, k + a) }
                            } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position) if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === n % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2,
                              g = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c, y1: e - n / 2, x2: g, y2: l + n / 2 }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(c, l); else if ("wavy" === this.type) {
                                s = c; k = e; f = 0.5; m = (g - s) / a / 3; for (q = 0; q < m; q++)this.ctx.bezierCurveTo(s + a, k + f * a, s + 2 * a, k + f * a, s + 3 * a, k), s += 3 * a, f *= -1; this.ctx.bezierCurveTo(s + a, k + f * a, s + 2 * a, k + f * a, s + 3 * a, k); k = l; f *= -1; this.ctx.lineTo(s,
                                  k); for (q = 0; q < m; q++)this.ctx.bezierCurveTo(s - a, k + f * a, s - 2 * a, k + f * a, s - 3 * a, k), s -= 3 * a, f *= -1
                              } else if ("zigzag" === this.type) { f = 1; k = e - a; s = c + a; m = (g - s) / a / 2; for (q = 0; q < m; q++)this.ctx.lineTo(s, k), k += 2 * f * a, s += 2 * a, f *= -1; this.ctx.lineTo(s, k); k += l - e; for (q = 0; q < m + 1; q++)this.ctx.lineTo(s, k), k += 2 * f * a, s -= 2 * a, f *= -1; this.ctx.lineTo(s + a, k + f * a) } 0 < n && this.ctx.stroke(); this.ctx.closePath(); this.ctx.globalAlpha = this.fillOpacity; this.ctx.globalCompositeOperation = "destination-over"; this.ctx.fill(); this.ctx.restore(); this.ctx.globalAlpha =
                                b; this.ctx = d
                    }
                    ...
                    this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value),
                      d = Math.abs("pixel" === this._thicknessType ? this.thickness : Math.abs(this.parent.convertValueToPixel(this.endValue) - this.parent.convertValueToPixel(this.startValue))); if (0 < d) {
                        var b = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var c = this.ctx.globalAlpha; this.ctx.globalAlpha = b; P(this.id); var e, f, g, l; this.ctx.lineWidth = d; this.ctx.setLineDash && this.ctx.setLineDash(N(this.lineDashType, d)); if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 ===
                          this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: g, x2: f + d / 2, y2: l }; else if ("left" === this.parent._position || "right" === this.parent._position) g = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = { x1: e, y1: g - d / 2, x2: f, y2: l + d / 2 }; this.ctx.moveTo(e, g); this.ctx.lineTo(f, l); this.ctx.stroke(); this.ctx.globalAlpha = c
                      } this.ctx.restore()
                    ...
                    this.chart.renderCrosshairs(this.parent); this._hidden = !0
                  }; $.prototype.render = function (a, d, b) {
                    var c, e, f, g, l = null, w = null, k = null, m = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
                      var n = 0, n = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ?
                        0 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0); this.valueFormatString = E.generateValueFormatString(this.parent.range, n)
                      ...
                      this.parent.labelFontSize : this.labelFontSize); this.labelMaxWidth = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width : this.labelMaxWidth; this.labelMaxHeight = s(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize; 0 < n && q.setLineDash && q.setLineDash(N(this.lineDashType, n)); k = new ia(q, {
                        x: 0, y: 0, padding: { top: 2, right: 3, bottom: 2, left: 4 }, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness, cornerRadius: this.labelCornerRadius,
                        maxWidth: this.labelMaxWidth, maxHeight: this.labelMaxHeight, angle: this.labelAngle, text: m, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle"
                      }); if (this.snapToDataPoint) {
                        var r = 0, m = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                          var v = null; if ("bottom" === this.parent._position || "top" === this.parent._position) r = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
                              ...
                              0, r = y = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x < m[r].dataPoint.y.length; x++)u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r); else A += m[r].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(A)), u < v && (v = u, y = r); else if ("stackedBar100" === m[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), C = A = u = 0, r = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x < m[r].dataPoint.y.length; x++)u =
                                Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r); else A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, y = r); else for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = y = u = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x < m[r].dataPoint.y.length; x++)u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])),
                                  u < v && (v = u, y = r); else u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, y = r); x = m[y]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                                    c = 0; if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                                      v = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[0])); for (r = u = 0; r < x.dataPoint.y.length; r++)u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[r])), u < v && (v = u, c = r); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[c]) <<
                                        0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0; this.value = x.dataPoint.y[c]; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y[c] }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y[c], this.valueFormatString, this.chart._cultureInfo) : this.label
                                      ...
                                      v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)); A = u = 0; for (r = y; 0 <= r; r--)A += m[r].dataPoint.y, u = Math.abs(a -
                                        this.parent.convertValueToPixel(A)), u < v && (v = u, c = r); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A) << 0) + 0.5 : this.parent.convertValueToPixel(A) << 0; this.value = A; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                                      ...
                                      C = A = u = 0; for (r = y; 0 <= r; r--)A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, c = r); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0; this.value = C; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : C }) : s(this.options.label) ? ea(b ?
                                        b : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                                    } else l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, this.value = x.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label; c = e = l; f = this.chart.plotArea.y1; g = this.chart.plotArea.y2;
                                    this.bounds = { x1: c - n / 2, y1: f, x2: e + n / 2, y2: g }; k.x = c - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 ? k.x = this.chart.bounds.x2 - k.width : k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1); k.y = this.parent.lineCoordinates.y2 + ("top" === this.parent._position ? -k.height + this.parent.tickLength : k.fontSize / 2) + 2; k.y + k.height > this.chart.bounds.y2 ? k.y = this.chart.bounds.y2 - k.height : k.y < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1)
                                  } else if ("left" === this.parent._position || "right" === this.parent._position) {
                                    f =
                                    g = w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0; c = this.chart.plotArea.x1; e = this.chart.plotArea.x2; this.bounds = { x1: c, y1: f - n / 2, x2: e, y2: g + n / 2 }; C = !1; if (this.parent.labels) for (m = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += m)if (this.parent.labels[r]) C = !0; else { C = !1; break } if (C) {
                                    ...
                                    } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.x }) : s(this.options.label) ? Aa(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
                                      this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.x }) : s(this.options.label) ? ea(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); this.value = x.dataPoint.x; k.y = g + k.fontSize / 2 - k.measureText().height / 2 + 2; k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y =
                                        this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2); "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2)
                                  }
                        } else if ("bottom" === this.parent._position || "top" === this.parent._position) {
                          r = this.parent.convertPixelToValue({ x: a }); for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y &&
                            v.dataSeries.visible && m.push(v)); if (0 === m.length) return; m.sort(function (a, b) { return a.distance - b.distance }); x = m[0]; c = e = l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0; f = this.chart.plotArea.y1; g = this.chart.plotArea.y2; this.bounds = { x1: c - n / 2, y1: f, x2: e + n / 2, y2: g }; C = !1; if (this.parent.labels) for (m = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += m)if (this.parent.labels[r]) C = !0; else { C = !1; break } if (C) {
                              if ("axisX" ===
                              ...
                              value: x.dataPoint.x
                            }) : s(this.options.label) ? Aa(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : s(this.options.label) ? ea(b ? b : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); this.value = x.dataPoint.x; k.x = c - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 -
                          ...
                          !s(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (r = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a })); for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r,
                              ...
                              r = u = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x < m[r].dataPoint.y.length; x++)u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r); else u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, y = r); else if ("stackedColumn" === m[0].dataSeries.type || "stackedArea" === m[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = A = u = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x <
                                m[r].dataPoint.y.length; x++)u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r); else A += m[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(A)), u < v && (v = u, y = r); else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = C = A = u = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x < m[r].dataPoint.y.length; x++)u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])),
                                  u < v && (v = u, y = r); else A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, y = r); else for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = u = 0; r < m.length; r++)if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (x = 0; x < m[r].dataPoint.y.length; x++)u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r); else u = Math.abs(d -
                                    this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, y = r); x = m[y]; c = 0; if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                                      v = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[0])); for (r = u = 0; r < x.dataPoint.y.length; r++)u =
                                        Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])), u < v && (v = u, c = r); w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y[c] }) : s(this.options.label) ? ea(b ? b : x.dataPoint.y[c], this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = x.dataPoint.y[c]
                                    } else if ("stackedColumn" ===
                                      this.parent.dataSeries[y].type || "stackedArea" === this.parent.dataSeries[y].type) {
                                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)); A = u = 0; for (r = y; 0 <= r; r--)A += m[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(A)), u < v && (v = u, c = r); w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A) << 0) + 0.5 : this.parent.convertValueToPixel(A) << 0; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : x.dataPoint.y }) : s(this.options.label) ?
                                          ea(b ? b : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = A
                          } else if ("stackedColumn100" === this.parent.dataSeries[y].type || "stackedArea100" === this.parent.dataSeries[y].type) {
                            v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)); A = u = 0; for (r = y; 0 <= r; r--)A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, c = r); w =
                          ...
                          k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2), c >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && (0 < n && (q.moveTo(c, f), q.lineTo(e, g), q.stroke(), this._hidden = !1), q.restore(), !s(k.text) && ("number" === typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0)); if ("left" ===
                            this.parent._position || "right" === this.parent._position) "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), g >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 <
                              n && (q.moveTo(c, f), q.lineTo(e, g), q.stroke(), this._hidden = !1), q.restore(), !s(k.text) && ("number" === typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0))
                      } else {
                        if ("bottom" === this.parent._position || "top" === this.parent._position) c = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = { x1: c - n / 2, y1: f, x2: e + n / 2, y2: g }; else if ("left" === this.parent._position || "right" === this.parent._position) f = g = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, c = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                          this.bounds = { x1: c, y1: f - n / 2, x2: e, y2: g + n / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                            C = !1; if (this.parent.labels) for (m = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += m)if (this.parent.labels[r]) C = !0; else { C = !1; break } if (C) {
                              if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({ y: d }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index &&
                                (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? v.dataPoint.label : this.label)
                            } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : this.parent.convertPixelToValue(d) }) : s(this.options.label) ? Aa(b ? b : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                            ...
                            if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? ea(b ? b : this.parent.convertPixelToValue(a),
                              this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = c - k.measureText().width / 2, k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width), k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                          } else if ("bottom" === this.parent._position || "top" === this.parent._position) {
                              ...
                              r = 0; r < this.parent.viewportMaximum; r += m)if (this.parent.labels[r]) C = !0; else { C = !1; break } if (C) { if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({ x: a }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? b ? b : v.dataPoint.label : this.label) } else "dateTime" ===
                                this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? Aa(b ? b : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                                  chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ? b : 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) :
                                    ""
                                }) : s(this.options.label) ? ea(b ? b : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label); k.x = c - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width); k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1); "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                  ...
                  }; X.prototype.mouseMoveHandler = function (a, d) { this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d)) }; X.prototype._updateToolTip = function (a, d, b) {
                    b = "undefined" === typeof b ? !0 : b; this.container || this._initialize();
                    this.enabled || this.hide(); if (!this.chart.disableToolTip) {
                      if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY = d; var c = null, e = null, f = [], g = 0; if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                          var l = []; if (this.chart.axisX) for (var v = 0; v < this.chart.axisX.length; v++) {
                            for (var g = this.chart.axisX[v].convertPixelToValue({ y: d }), k =
                              null, c = 0; c < this.chart.axisX[v].dataSeries.length; c++)(k = this.chart.axisX[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[c], null !== k.dataPoint.y && l.push(k)); k = null
                          } if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++) {
                            g = this.chart.axisX2[v].convertPixelToValue({ y: d }); k = null; for (c = 0; c < this.chart.axisX2[v].dataSeries.length; c++)(k = this.chart.axisX2[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[c],
                              null !== k.dataPoint.y && l.push(k)); k = null
                          }
                        } else {
                          l = []; if (this.chart.axisX) for (v = 0; v < this.chart.axisX.length; v++)for (g = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX[v].dataSeries.length; c++)(k = this.chart.axisX[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[c], null !== k.dataPoint.y && l.push(k)); if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++)for (g = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX2[v].dataSeries.length; c++)(k =
                            this.chart.axisX2[v].dataSeries[c].getDataPointAtX(g, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[c], null !== k.dataPoint.y && l.push(k))
                        } if (0 === l.length) return; l.sort(function (a, b) { return a.distance - b.distance }); b = l[0]; for (c = 0; c < l.length; c++)l[c].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() && f.push(l[c]); l = null
                      } else {
                        if (k = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex = k.dataSeries.index; else if (w) if (k = Ya(a, d, this.chart._eventManager.ghostCtx),
                          0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) { k = this.chart._eventManager.objectMap[k]; if ("legendItem" === k.objectType) return; this.currentSeriesIndex = k.dataSeriesIndex; this.currentDataPointIndex = 0 <= k.dataPointIndex ? k.dataPointIndex : -1 } else this.currentDataPointIndex = -1; else this.currentDataPointIndex = -1; if (0 <= this.currentSeriesIndex) {
                            e = this.chart.data[this.currentSeriesIndex]; k = {}; if (0 <= this.currentDataPointIndex) c = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint =
                              c, k.index = this.currentDataPointIndex, k.distance = Math.abs(c.x - g), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum); else {
                                if (!this.enabled || "line" !== e.type && "stepLine" !== e.type && "spline" !== e.type && "area" !== e.type && "stepArea" !== e.type && "splineArea" !== e.type && "stackedArea" !== e.type && "stackedArea100" !== e.type && "rangeArea" !== e.type && "rangeSplineArea" !== e.type && "candlestick" !==
                                  e.type && "ohlc" !== e.type && "boxAndWhisker" !== e.type) return; g = e.axisX.convertPixelToValue({ x: a }); k = e.getDataPointAtX(g, b); s(k) || (k.dataSeries = e, this.currentDataPointIndex = k.index, c = k.dataPoint)
                            } if (!s(k) && !s(k.dataPoint) && !s(k.dataPoint.y)) if (k.dataSeries.axisY) if (0 < k.dataPoint.y.length) { for (c = b = 0; c < k.dataPoint.y.length; c++)k.dataPoint.y[c] < k.dataSeries.axisY.viewportMinimum ? b-- : k.dataPoint.y[c] > k.dataSeries.axisY.viewportMaximum && b++; b < k.dataPoint.y.length && b > -k.dataPoint.y.length && f.push(k) } else "column" ===
                        ...
                        if (this.highlightObjects(f), this.enabled) {
                          b = ""; b = this.getToolTipInnerHTML({ entries: f });
                          if (null !== b) {
                            this.contentDiv.innerHTML = b; g = !1; "none" === this.container.style.display && (g = !0, this.container.style.display = "block"); try {
                          ...
                          } else this.hide(!1), this.enabled && this.dispatchEvent("hidden", { chart: this.chart, toolTip: this }, this); d = []; for (c = 0; c < f.length; c++)d.push({
                            xValue: f[c].dataPoint.x,
                            dataPoint: f[c].dataPoint, dataSeries: f[c].dataSeries, dataPointIndex: f[c].index, dataSeriesIndex: f[c].dataSeries._index
                          }); d = { chart: this.chart, toolTip: this.options, content: b, entries: d }; this._entries = f; this.dispatchEvent("updated", d, this)
                        }
                    ...
                    var d = this.chart.overlaidCanvasCtx; if (s(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas) this.chart.resetOverlayedCanvas(),
                      d.clearRect(0, 0, this.chart.width, this.chart.height), this.chart.clearedOverlayedCanvas = "toolTip"; d.save(); var b = this.chart.plotArea, c = 0; d.beginPath(); d.rect(b.x1, b.y1, b.x2 - b.x1, b.y2 - b.y1); d.clip(); for (b = 0; b < a.length; b++) {
                        var e = a[b]; if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                          var c = this.chart.data[e.dataSeriesIndex], f = c.dataPoints[e.dataPointIndex], g = e.dataPointIndex; !1 === f.highlightEnabled || !0 !== c.highlightEnabled && !0 !== f.highlightEnabled ||
                                  ...
                                  d.lineTo(e.x3 - c, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - c, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - c, Math.max(e.y2, e.y3)), d.stroke(), ca(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : "ohlc" === c.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, c = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - c, e.y2), d.lineTo(e.x3 - c, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1,
                                    e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : "boxAndWhisker" === c.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), ca(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness /
                                      2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y4), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y4), d.stroke(), d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y1), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y1),
                                        d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === c.type && y(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                        }
                      } d.restore(); d.globalAlpha = 1; d.beginPath()
                  }; X.prototype.getToolTipInnerHTML = function (a) {
                    a = a.entries; for (var d = null, b = null, c = null, e = 0, f = "", g = !0, l = 0; l < a.length; l++)if (a[l].dataSeries.toolTipContent ||
                      a[l].dataPoint.toolTipContent) { g = !1; break } if (g && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a); else if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
                        for (var s = null, k = "", l = 0; l < a.length; l++)b = a[l].dataSeries, c = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (g && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? k += "undefined" !== typeof this.chart.axisX[0].labels[c.x] ?
                          this.chart.axisX[0].labels[c.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (k += "undefined" !== typeof this.chart.axisX2[0].labels[c.x] ? this.chart.axisX2[0].labels[c.x] : "{x}"), k += "</br>", k = this.chart.replaceKeywordsWithValue(k, c, b, e)), null === c.toolTipContent || "undefined" === typeof c.toolTipContent && null === b.options.toolTipContent || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" ===
                            ...
                            null === d && (d = ""), !0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, c, b, e) + d, l < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, c, b, e), l < a.length - 1 && (d += "</br>"))); null !== d && (d = k + d)
                      } else {
                        ...
                        null === d && (d = ""); d += this.chart.replaceKeywordsWithValue(f, c, b, e)
                      } return d
                    ...
                    if (!this.enabled) return !1;
                    this.chart.clearedOverlayedCanvas = null; var b, c, e, f = []; e = !1; d = !s(d) && 0 <= d && d < this.chart.data.length ? d : 0; if (this.shared) for (var g = 0; g < this.chart.data.length; g++)b = this.chart.data[g], (c = b.getDataPointAtX(a, !1)) && (c.dataPoint && !s(c.dataPoint.y) && b.visible) && (c.dataSeries = b, f.push(c)); else b = this.chart.data[d], (c = b.getDataPointAtX(a, !1)) && (c.dataPoint && !s(c.dataPoint.y) && b.visible) && (c.dataSeries = b, f.push(c)); if (0 < f.length) {
                      for (g = 0; g < f.length; g++)if (c = f[g], c.dataPoint.x < c.dataSeries.axisX.viewportMinimum ||
                        c.dataPoint.x > c.dataSeries.axisX.viewportMaximum || c.dataPoint.y < c.dataSeries.axisY.viewportMinimum || c.dataPoint.y > c.dataSeries.axisY.viewportMaximum) e = !0; else { e = !1; break } if (e) return this.hide(), !1; this.highlightObjects(f); this._entries = f; c = ""; c = this.getToolTipInnerHTML({ entries: f }); if (null !== c) {
                          this.contentDiv.innerHTML = c; c = !1; "none" === this.container.style.display && (c = !0, this.container.style.display = "block"); try {
                          ...
                          } catch (l) { } "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type ? b = mouseX - 10 - this.container.clientWidth : (b = "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) -
                            this.container.clientWidth << 0 : f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) - this.container.clientWidth << 0, b -= 10); 0 > b && (b += this.container.clientWidth + 20); b + this.container.clientWidth > Math.max(this.chart.container.clientWidth, this.chart.width) && (b = Math.max(0, Math.max(this.chart.container.clientWidth, this.chart.width) - this.container.clientWidth)); f = 1 !== f.length || this.shared || "line" !== f[0].dataSeries.type && "stepLine" !== f[0].dataSeries.type && "spline" !== f[0].dataSeries.type && "area" !== f[0].dataSeries.type &&
                              "stepArea" !== f[0].dataSeries.type && "splineArea" !== f[0].dataSeries.type ? "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) : f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) : f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y); f = -f + 10; 0 < f + this.container.clientHeight + 5 && (f -= f + this.container.clientHeight + 5 - 0); this.fixMozTransitionDelay(b,
                                f); !this.animationEnabled || c ? this.disableAnimation() : (this.enableAnimation(), this.container.style.MozTransition = this.mozContainerTransition); this.container.style.left = b + "px"; this.container.style.bottom = f + "px"
                    ...
                    if ("mousemove" === a.type || "click" === a.type) {
                      var d = [], b = Na(a), c = null; if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c]) if (c = this.objectMap[c], "dataPoint" === c.objectType) {
                        var e = this.chart.data[c.dataSeriesIndex], f = e.dataPoints[c.dataPointIndex], g = c.dataPointIndex; c.eventParameter = {
                          x: b.x, y: b.y, dataPoint: f,
                    ...
                    var f = this; this.chart.isAnimating = !0; e = e || K.easing.linear; b && this.animations.push({ startTime: (new Date).getTime() + (a ? a : 0), duration: d, animationCallback: b, onComplete: c }); for (a = []; 0 < this.animations.length;)if (d = this.animations.shift(), b = (new Date).getTime(), c = 0, d.startTime <= b && (c = e(Math.min(b - d.startTime,
                    ...
                    yScaleAnimation: function (a, d) { if (0 !== a) { var b = d.dest, c = d.source.canvas, e = d.animationBase; b.drawImage(c, 0, 0, c.width, c.height, 0, e - e * a, b.canvas.width / ka, a * b.canvas.height / ka) } }, xScaleAnimation: function (a, d) { if (0 !== a) { var b = d.dest, c = d.source.canvas, e = d.animationBase; b.drawImage(c, 0, 0, c.width, c.height, e - e * a, 0, a * b.canvas.width / ka, b.canvas.height / ka) } }, xClipAnimation: function (a, d) {
                      if (0 !== a) {
                        var b = d.dest, c = d.source.canvas; b.save(); 0 < a && b.drawImage(c, 0, 0, c.width * a, c.height, 0, 0, c.width * a / ka, c.height /
                          ka); b.restore()
                      }
                    ...
                    drawMarker: function (a,
                      ...
                      for (var d = 0; d < a.length; d++) {
                        var b = a[d]; V.drawMarker(b.x, b.y, b.ctx, b.type,
                          b.size, b.color, b.borderColor, b.borderThickness)
                      }
                    }
                  }; return l
      }(); y.version = "v3.4.4 GA"; window.CanvasJS && (y && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = y)
})();
